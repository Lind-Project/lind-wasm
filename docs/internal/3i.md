...
3i (Three-I) provides a general mechanism for [cages](../index.md#cages) (and [grates](../index.md#grates)) to make system calls and intercept system calls via a programmable system call table. The goal is to enable complex functionality without modifying the [microvisor](../index.md#microvisor-rawposix) or increasing the microvisor’s trusted computing base.
