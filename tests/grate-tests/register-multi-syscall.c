...
int main(int argc, char *argv[]) {
  ...
  // Register second syscall handler
  fn_ptr_addr = (uint64_t)(uintptr_t)&getuid_grate;
  ret = register_handler(grateid, 102, 1, grateid, fn_ptr_addr);
