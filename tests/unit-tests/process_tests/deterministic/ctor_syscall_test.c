/* Test that syscalls work from constructors (__attribute__((constructor))).
   This validates that __grateos_init_addr_translation runs before user
   ...
   __grateos_cageid is still 0.  See issue #883.  */
...
{
    /* This syscall requires __grateos_cageid to be initialized.
