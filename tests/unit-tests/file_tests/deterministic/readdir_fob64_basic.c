...
int main(int argc, char *argv[], char *envp[]) {
    ...
    const char *test_dir = "testfiles/readdir_fob64_basic_dir";
    const char *alpha_path = "testfiles/readdir_fob64_basic_dir/alpha";
    const char *beta_path = "testfiles/readdir_fob64_basic_dir/beta";
    const char *gamma_path = "testfiles/readdir_fob64_basic_dir/gamma";
