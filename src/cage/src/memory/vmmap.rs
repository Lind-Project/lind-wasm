...
use sysdefs::constants::fs_const::{PAGESHIFT, PAGESIZE, PROT_EXEC, PROT_NONE, PROT_READ, PROT_WRITE};
...
impl Vmmap {
    ...
    pub fn check_addr_read(&mut self, addr: u64, length: usize) -> bool {
        ...
        self.check_addr_mapping(page_num, npages, PROT_READ).is_some()
    }
    ...
    pub fn check_addr_write(&mut self, addr: u64, length: usize) -> bool {
        ...
        self.check_addr_mapping(page_num, npages, PROT_WRITE).is_some()
    }
    ...
    pub fn check_addr_rw(&mut self, addr: u64, length: usize) -> bool {
        ...
        self.check_addr_mapping(page_num, npages, PROT_READ | PROT_WRITE).is_some()
    }
}
