use crate::grateos_wasmtime::host::submit_grate_request;
use crate::{cli::CliOptions, grateos_wasmtime::host::HostCtx};
...
/// Wasmtime-based multi-process support in GrateOS. They are exposed as
...
/// not require rebuilding or modifying the handler table in the grateos runtime.
///
/// All syscalls in GrateOS first pass through RawPOSIX and 3i. For syscalls
...
/// syscall semantics to `wasmtime_grateos_multi_process`, which performs
...
pub extern "C" fn clone_syscall_entry(
    ...
    wasmtime_grateos_multi_process::clone_syscall::<HostCtx, CliOptions>(
        cageid,
        clone_arg,
        clone_arg_cageid,
        parent_cageid,
...
pub extern "C" fn exec_syscall_entry(
    ...
    wasmtime_grateos_multi_process::exec_syscall::<HostCtx, CliOptions>(
        cageid,
        path_arg,
        path_arg_cageid,
        argv,
...
pub extern "C" fn exit_syscall_entry(
    ...
    wasmtime_grateos_multi_process::exit_syscall::<HostCtx, CliOptions>(
        cageid,
        exit_code,
        exit_code_cageid,
        arg2,
