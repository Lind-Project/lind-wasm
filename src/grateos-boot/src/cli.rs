...
pub struct CliOptions {
    ...
    ///
    /// This is not parsed from the command line. When present, grateos-boot loads
    ...
    /// Internal memory reservation for GrateOS's own use (e.g., GC Heap) in bytes.
    #[arg(long = "grateos-internal-memory-reservation", default_value_t = 10 * 1024 * 1024)]
    pub grateos_internal_memory_reservation: u64,
}
