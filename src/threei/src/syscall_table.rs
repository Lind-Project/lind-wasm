use rawposix::fs_calls::{
    ...
    pread_syscall, pwrite_syscall, fchmod_syscall, fchdir_syscall, writev_syscall, fstat_syscall,
    ftruncate_syscall, fstatfs_syscall, getdents_syscall, lseek_syscall,
...
pub const SYSCALL_TABLE: &[(u64, Raw_CallFunc)] = &[
    ...
    (120, fstat_syscall),
    (121, fstatfs_syscall),
    (124, ftruncate_syscall),
    (98, futex_syscall),
    (131, mkdir_syscall),
    (146, writev_syscall),
    (217, getdents_syscall),
    (172, wait_syscall),
    (173, waitpid_syscall),
    (175, brk_syscall),
    (176, sbrk_syscall),
