...
//!
//! This file contains all file system related constants that aligns with POSIX standard. RawPOSIX imports all required constants
...
pub const LIND_ROOT: &str = "/home/alice/lind-wasm/src/RawPOSIX/tmp";
