...
use super::fs_calls::{
    ...
    clock_gettime_syscall, close_syscall, dup2_syscall, dup3_syscall, dup_syscall, faccessat_syscall,
    fchdir_syscall, fchmod_syscall, fchmodat_syscall, fchownat_syscall, fcntl_syscall,
    fdatasync_syscall, flock_syscall, fstat_syscall, fstatat_syscall, fstatfs_syscall,
    fsync_syscall, ftruncate_syscall, futex_syscall, getcwd_syscall, getdents_syscall,
    getrandom_syscall, ioctl_syscall, lchown_syscall, link_syscall, listxattr_syscall,
    lseek_syscall, lstat_syscall, mkdir_syscall, mknod_syscall, mmap_syscall, mprotect_syscall,
    munmap_syscall, nanosleep_time64_syscall, open_syscall, openat_syscall, pipe2_syscall,
    pipe_syscall, pread_syscall, preadv_syscall, pwrite_syscall, pwritev_syscall, read_syscall,
    readlink_syscall, readlinkat_syscall, readv_syscall, rename_syscall, renameat2_syscall,
    renameat_syscall, rmdir_syscall, setxattr_syscall, shmat_syscall, shmctl_syscall,
...
pub const SYSCALL_TABLE: &[(u64, RawCallFunc)] = &[
    ...
    (syscall_const::FCHOWNAT_SYSCALL as u64, fchownat_syscall),
    ...
    (syscall_const::FACCESSAT_SYSCALL as u64, faccessat_syscall),
