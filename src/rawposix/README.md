# RawPOSIX [![Build Status](https://github.com/GrateOS-Project/safeposix-rust/actions/workflows/grateos-selfhost.yml/badge.svg?branch=develop)](https://github.com/GrateOS-Project/safeposix-rust/actions/workflows/grateos-selfhost.yml)

## Contents

* [Home](https://github.com/GrateOS-Project/grateos-docs/blob/main/docs/RustPOSIX/Home.md)
* [Architecture](https://github.com/GrateOS-Project/grateos-docs/blob/main/docs/RustPOSIX/Architecture.md)
* [Interface](https://github.com/GrateOS-Project/grateos-docs/blob/main/docs/RustPOSIX/Interface.md)
* [Run Independently](https://github.com/GrateOS-Project/grateos-docs/blob/main/docs/RustPOSIX/Run-Independently.md)
* [Security Model](https://github.com/GrateOS-Project/grateos-docs/blob/main/docs/RustPOSIX/Security-Model.md)
* [Style Guide](https://github.com/GrateOS-Project/grateos-docs/blob/main/docs/RustPOSIX/Style-Guide.md)
* [Testing and Debugging](https://github.com/GrateOS-Project/grateos-docs/blob/main/docs/RustPOSIX/Testing-and-Debugging.md)

## Overview
This document provides a step-by-step guide to access the NYU SSH server and run Docker commands to set up and test the GrateOS project. If you face issues while accessing the server, troubleshooting steps are included to help you resolve them efficiently.
...
```bash
[username]@grateos-server.engineering.nyu.edu
```

**Description**: Replace `[username]` with your NYU username to connect to the GrateOS server. This command will initiate a secure shell connection to the server, allowing you to work on the remote system.
...
```bash
docker run --privileged --ipc=host --cap-add=SYS_PTRACE -it securesystemslab/grateos /bin/bash
```

**Description**: This command starts a Docker container using the image `securesystemslab/grateos`. The options used are:
...
2. **Build the Regular GrateOS Version**:
   - Run the following command to build the standard version of GrateOS:

     ```bash
     make -1
     ```

     **Description**: This command builds the standard version of GrateOS, preparing it for use.
...
1. **Navigate to the project directory and set up the environment**:
    ...
    git clone https://github.com/GrateOS-Project/RawPOSIX.git
    mv RawPOSIX/ safeposix-rust
    cd /home/grateos/grateos_project
    make -1
    ```
    ...
    **Description**:
    ...
    - `cd /home/grateos/grateos_project`: Change to the GrateOS project directory.
...
**Description**: This command runs the full test suite for GrateOS, verifying that all components are functioning as expected.
...
```bash
cargo test ut_grateos_fs_mkdir_invalid_modebits
```
...
2. **Encountering a smaller issue**:
   - Check if an existing issue is logged. If not, create one at: [https://github.com/GrateOS-Project/RawPOSIX/issues/15](https://github.com/GrateOS-Project/RawPOSIX/issues/15).
...
See reference at [Run RustPOSIX Independently](https://github.com/GrateOS-Project/grateos-docs/blob/main/docs/RustPOSIX/Run-Independently.md)

See reference at [Testing and Debugging](https://github.com/GrateOS-Project/grateos-docs/blob/main/docs/RustPOSIX/Testing-and-Debugging.md)
