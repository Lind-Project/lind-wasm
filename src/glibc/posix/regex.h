...
#  ifdef __USE_GNU
  ...
  /* Compile the regular expression PATTERN, with length LENGTH
     ...
     'regfree'.  */
  extern const char *re_compile_pattern (const char *__pattern,
					 size_t __length,
  ...
  extern regoff_t
  re_match_2 (struct re_pattern_buffer *__buffer, const char *__string1,
	      regoff_t __length1, const char *__string2, regoff_t __length2,
  ...
  extern void re_set_registers (struct re_pattern_buffer *__buffer,
				struct re_registers *__regs,
				__re_size_t __num_regs, regoff_t *__starts,
				regoff_t *__ends);
#  endif /* Use GNU */
...
#    elif ((199901L <= __STDC_VERSION__                                       \
	    || 3 < __GNUC__ + (1 <= __GNUC_MINOR__) || __clang_major__ >= 3)  \
	   && !defined __cplusplus)
...
#  endif
  ...
  extern int
  regexec (const regex_t *_Restrict_ __preg, const char *_Restrict_ __String,
	   size_t __nmatch,
