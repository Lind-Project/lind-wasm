...
#    define __GLOB_FLAGS                                                      \
      (GLOB_ERR | GLOB_MARK | GLOB_NOSORT | GLOB_DOOFFS | GLOB_NOESCAPE       \
       | GLOB_NOCHECK | GLOB_APPEND | GLOB_PERIOD | GLOB_ALTDIRFUNC           \
       | GLOB_BRACE | GLOB_NOMAGIC | GLOB_TILDE | GLOB_ONLYDIR                \
       | GLOB_TILDE_CHECK)
#  else
#    define __GLOB_FLAGS                                                      \
      (GLOB_ERR | GLOB_MARK | GLOB_NOSORT | GLOB_DOOFFS | GLOB_NOESCAPE       \
       | GLOB_NOCHECK | GLOB_APPEND | GLOB_PERIOD)
#  endif
...
extern int __REDIRECT_NTHNL (glob,
			     (const char *__restrict __pattern, int __flags,
			      int (*__errfunc) (const char *, int),
			      glob_t *__restrict __pglob),
			     __glob64_time64);

extern void __REDIRECT_NTH (globfree, (glob_t * __pglob), __globfree64_time64);
#    else
extern int __REDIRECT_NTHNL (glob,
			     (const char *__restrict __pattern, int __flags,
			      int (*__errfunc) (const char *, int),
...
#  ifdef __USE_LARGEFILE64
#    ifdef __USE_TIME_BITS64
extern int __REDIRECT_NTHNL (glob64,
			     (const char *__restrict __pattern, int __flags,
			      int (*__errfunc) (const char *, int),
