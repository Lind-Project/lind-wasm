...
do_test (void)
{
  ...
  e = re_search (&r, "\x61\x61\x61\x61\x61\xb7\xef\x61\xbf\xb7\xbd\xe8", 12, 0,
		 12, &s);
  if (e != -1)
    {
  ...
  e = re_search (&r, "\x61\x61\x61\x61\xb7\xef\x61\xbf\xb7\xbd\xe8", 11, 0, 11,
		 &s);
  if (e != -1)
    {
   ...
   * this is a reproducer of BZ #13637 */
  e = re_search (&r, "\x61\x61\x61\xb7\xef\x61\xbf\xb7\xbd\xe8", 10, 0, 10,
		 &s);
  if (e != -1)
    {
  ...
  e = re_search (&r, "\x61\x61\xb7\xef\x61\xbf\xb7\xbd\xe8", 9, 0, 9, &s);
  if (e != -1)
    {
  ...
  e = re_search (&r, "\x61\xb7\xef\x61\xbf\xb7\xbd\xe8", 8, 0, 8, &s);
  if (e != -1)
    {
  ...
  /* 新処圭新処, \xb7\xbd here really matches 圭, but second occurrence is a
   * false match, this is a reproducer of bug-regex25 and BZ #13637 */
  e = re_search (&r, "\xbf\xb7\xbd\xe8\xb7\xbd\xbf\xb7\xbd\xe8", 10, 0, 10,
		 &s);
  if (e != 4)
    {
      printf ("bug-regex33.6: no match or false match: re_search() returned "
	      "%d, should return 4\n",
	      e);
      rc = 1;
    }
  ...
  e = re_search (&r, "\xbf\xb7\xbd\xe8\xb7\xbd\xbf\xb7", 9, 0, 9, &s);
  if (e != 4)
    {
      printf ("bug-regex33.7: no match or false match: re_search() returned "
	      "%d, should return 4\n",
	      e);
      rc = 1;
    }
