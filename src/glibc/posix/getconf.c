...
#if (defined _SC_V6_ILP32_OFF32 && defined _SC_V7_LPBIG_OFFBIG                \
     && defined _SC_XBS5_LP64_OFF64 && defined _SC_V6_LP64_OFF64              \
     && defined _SC_V7_ILP32_OFFBIG && defined _SC_V6_LPBIG_OFFBIG            \
     && defined _SC_V7_LP64_OFF64 && defined _SC_V7_ILP32_OFF32               \
     && defined _SC_XBS5_LPBIG_OFFBIG && defined _SC_XBS5_ILP32_OFFBIG        \
     && defined _SC_V6_ILP32_OFFBIG && defined _SC_XBS5_ILP32_OFF32)
...
%s.\n"),
  ...
  if (argc > 1 && strncmp (argv[1], "-v", 2) == 0)
  ...
  else
    {
      ...
      memcpy (mempcpy (default_name, getconf_dir, getconf_dirlen), "/default",
	      sizeof "/default");
...
#  endif
	  {
	    ...
	    memcpy (
		mempcpy (mempcpy (getconf_name, getconf_dir, getconf_dirlen),
			 "/", 1),
		spec, spec_len + 1);
	    args[0] = argv0;
	    args[1] = "-v";
