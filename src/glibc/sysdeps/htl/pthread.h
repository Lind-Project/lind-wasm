...
pthread_attr_getinheritsched (const pthread_attr_t *__restrict __attr,
			      int *__restrict __inheritsched) __THROW
    __nonnull ((1, 2));

/* Set the value of the inheritsched attribute in *ATTR to
   INHERITSCHED.  */
extern int pthread_attr_setinheritsched (pthread_attr_t *__attr,
					 int __inheritsched) __THROW
    __nonnull ((1));

/* Return the value of the schedparam attribute in *ATTR in *PARAM.  */
extern int
pthread_attr_getschedparam (const pthread_attr_t *__restrict __attr,
			    struct sched_param *__restrict __param) __THROW
    __nonnull ((1, 2));
...
extern int
pthread_attr_getschedpolicy (const pthread_attr_t *__restrict __attr,
			     int *__restrict __policy) __THROW
    __nonnull ((1, 2));
...
extern int pthread_attr_getstackaddr (const pthread_attr_t *__restrict __attr,
				      void **__restrict __stackaddr) __THROW
    __nonnull ((1, 2));
...
extern int pthread_attr_getguardsize (const pthread_attr_t *__restrict __attr,
				      size_t *__restrict __guardsize) __THROW
    __nonnull ((1, 2));
...
extern int pthread_getattr_np (pthread_t __thr, pthread_attr_t *__attr) __THROW
    __nonnull ((2));
#  endif
...
pthread_mutexattr_getprioceiling (const pthread_mutexattr_t *__restrict __attr,
				  int *__restrict __prioceiling) __THROW
    __nonnull ((1, 2));
...
pthread_mutexattr_gettype (const pthread_mutexattr_t *__restrict __attr,
			   int *__restrict __type) __THROW __nonnull ((1, 2));
...
pthread_mutex_init (struct __pthread_mutex *__restrict __mutex,
		    const pthread_mutexattr_t *__restrict __attr) __THROW
    __nonnull ((1));

/* Destroy the mutex __MUTEX.  */
extern int pthread_mutex_destroy (struct __pthread_mutex *__mutex) __THROW
    __nonnull ((1));
...
extern int
pthread_mutex_timedlock (struct __pthread_mutex *__restrict __mutex,
			 const struct timespec *__restrict __abstime) __THROWNL
    __nonnull ((1, 2));
#  endif
...
extern int pthread_mutex_clocklock (
    ...
    const struct timespec *__restrict __abstime) __THROWNL __nonnull ((1, 3));
#  endif
...
extern int pthread_mutex_setprioceiling (pthread_mutex_t *__restrict __mutex,
					 int __prio,
					 int *__restrict __oldprio) __THROW
    __nonnull ((1, 3));
#  endif
...
extern int pthread_mutex_consistent (pthread_mutex_t *__mtxp) __THROW
    __nonnull ((1));

#    ifdef __USE_GNU
extern int pthread_mutex_consistent_np (pthread_mutex_t *__mtxp) __THROW
    __nonnull ((1));
#    endif
#  endif
...
pthread_condattr_getclock (const pthread_condattr_t *__restrict __attr,
			   __clockid_t *__restrict __clock_id) __THROW
    __nonnull ((1, 2));
...
pthread_cond_init (pthread_cond_t *__restrict __cond,
		   const pthread_condattr_t *__restrict __attr) __THROW
    __nonnull ((1));
...
extern int pthread_cond_timedwait (
    ...
    __const struct timespec *__restrict __abstime) __nonnull ((1, 2, 3));
...
extern int pthread_spin_destroy (pthread_spinlock_t *__lock) __nonnull ((1));
...
extern int pthread_spin_lock (pthread_spinlock_t *__lock) __nonnull ((1));

/* Lock the spin lock object LOCK.  Fail if the lock is held by
   another thread.  */
extern int pthread_spin_trylock (pthread_spinlock_t *__lock) __nonnull ((1));

/* Unlock the spin lock object LOCK.  */
extern int pthread_spin_unlock (pthread_spinlock_t *__lock) __nonnull ((1));
...
extern int pthread_rwlock_timedrdlock (
    struct __pthread_rwlock *__restrict __rwlock,
    const struct timespec *__restrict __abstime) __THROWNL __nonnull ((1, 2));
#    endif
...
extern int
pthread_barrier_init (pthread_barrier_t *__restrict __barrier,
		      const pthread_barrierattr_t *__restrict __attr,
		      unsigned __count) __THROW __nonnull ((1));
...
extern int pthread_key_create (pthread_key_t *__key,
			       void (*__destructor) (void *)) __THROW
    __nonnull ((1));
...
#  define PTHREAD_ONCE_INIT                                                   \
    (struct __pthread_once) { __PTHREAD_ONCE_INIT }
...
extern int pthread_getcpuclockid (pthread_t __thr,
				  __clockid_t *__clock) __THROW
    __nonnull ((2));
#  endif
...
extern int
pthread_getschedparam (pthread_t __thr, int *__restrict __policy,
		       struct sched_param *__restrict __param) __THROW
    __nonnull ((2, 3));
