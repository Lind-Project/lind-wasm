...
#define __arch_compare_and_exchange_xxx_16_int(mem, new, old, mb1, mb2)       \
  ({                                                                          \
    unsigned long __tmp, __snew, __addr64;                                    \
    __asm__ __volatile__ (                                                    \
	mb1 "	andnot	%[__addr16],7,%[__addr64]\n"                             \
...
#define __arch_compare_and_exchange_xxx_64_int(mem, new, old, mb1, mb2)       \
  ({                                                                          \
    __asm__ __volatile__ (mb1 "1:	ldq_l	%[__prev],%[__mem]\n"                 \
			      "	cmpeq	%[__prev],%[__old],%[__cmp]\n"          \
			      "	beq	%[__cmp],2f\n"                            \
			      "	mov	%[__new],%[__cmp]\n"                      \
			      "	stq_c	%[__cmp],%[__mem]\n"                    \
...
#define __arch_exchange_8_int(mem, value, mb1, mb2)                           \
  ({                                                                          \
    ...
    __typeof (*mem) __ret;                                                    \
    __asm__ __volatile__ (mb1 "	andnot	%[__addr8],7,%[__addr64]\n"            \
...
#define __arch_exchange_16_int(mem, value, mb1, mb2)                          \
  ({                                                                          \
    unsigned long __tmp, __addr64, __sval;                                    \
    __typeof (*mem) __ret;                                                    \
    __asm__ __volatile__ (mb1 "	andnot	%[__addr16],7,%[__addr64]\n"           \
...
#define __arch_exchange_32_int(mem, value, mb1, mb2)                          \
  ({                                                                          \
    signed int __tmp;                                                         \
    __typeof (*mem) __ret;                                                    \
    __asm__ __volatile__ (mb1 "1:	ldl_l	%[__ret],%[__mem]\n"                  \
			      "	mov	%[__val],%[__tmp]\n"                      \
			      "	stl_c	%[__tmp],%[__mem]\n"                    \
			      "	beq	%[__tmp],1b\n" mb2                    \
...
#define __arch_exchange_64_int(mem, value, mb1, mb2)                          \
  ({                                                                          \
    unsigned long __tmp;                                                      \
    __typeof (*mem) __ret;                                                    \
    __asm__ __volatile__ (mb1 "1:	ldq_l	%[__ret],%[__mem]\n"                  \
			      "	mov	%[__val],%[__tmp]\n"                      \
			      "	stq_c	%[__tmp],%[__mem]\n"                    \
			      "	beq	%[__tmp],1b\n" mb2                    \
			  : [__ret] "=&r"(__ret), [__tmp] "=&r"(__tmp)        \
