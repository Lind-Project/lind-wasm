/* Machine-dependent ELF dynamic relocation inline functions.  OpenRISC
   version. Copyright (C) 2022-2024 Free Software Foundation, Inc. This file is
...
#define elf_machine_type_class(type)                                          \
  (((type) == R_OR1K_JMP_SLOT || (type) == R_OR1K_TLS_DTPMOD                  \
    || (type) == R_OR1K_TLS_DTPOFF || (type) == R_OR1K_TLS_TPOFF)             \
       * ELF_RTYPE_CLASS_PLT                                                  \
