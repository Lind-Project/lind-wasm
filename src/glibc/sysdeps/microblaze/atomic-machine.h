...
#define __arch_compare_and_exchange_val_32_acq(mem, newval, oldval)           \
  ({                                                                          \
    ...
    int test;                                                                 \
    __asm __volatile ("   addc    r0, r0, r0;"                                \
		      "1: lwx     %0, %3, r0;"                                \
		      "   addic   %1, r0, 0;"                                 \
		      "   bnei    %1, 1b;"                                    \
		      "   cmp     %1, %0, %4;"                                \
		      ...
		      "   bnei    %1, 1b;"                                    \
		      "2:"                                                    \
		      : "=&r"(__tmp), "=&r"(test), "=m"(*__memp)              \
		      : "r"(__memp), "r"(oldval), "r"(newval)                 \
		      : "cc", "memory");                                      \
    __tmp;                                                                    \
  })
...
#define __arch_atomic_increment_val_32(mem)                                   \
  ({                                                                          \
    ...
    __asm __volatile ("   addc    r0, r0, r0;"                                \
		      ...
		      "   addic   %1, r0, 0;"                                 \
		      "   bnei    %1, 1b;"                                    \
		      : "=&r"(__val), "=&r"(test), "=m"(*mem)                 \
		      : "r"(mem), "m"(*mem)                                   \
		      : "cc", "memory");                                      \
    __val;                                                                    \
  })

#define __arch_atomic_increment_val_64(mem) (abort (), (__typeof (*mem)) 0)
...
#define __arch_atomic_decrement_val_64(mem) (abort (), (__typeof (*mem)) 0)
