...
#    define READ_THREAD_POINTER()                                             \
      ({                                                                      \
	void *__result;                                                       \
	__asm__ __volatile__ ("mov %0, r31" : "=r"(__result));                \
	__result;                                                             \
      })

#  else
/* Define r31 as thread pointer register.  */
#    define READ_THREAD_POINTER() mov r0, r31;
#  endif /* __ASSEMBLER__ */
...
#    define TLS_INIT_TP(tcbp)                                                 \
      ({                                                                      \
	long int result_var;                                                  \
	result_var = INTERNAL_SYSCALL_CALL (                                  \
	    set_thread_area, (char *) (tcbp) + TLS_TCB_OFFSET);               \
...
#    define DB_THREAD_SELF CONST_THREAD_AREA (32, sizeof (struct pthread))
