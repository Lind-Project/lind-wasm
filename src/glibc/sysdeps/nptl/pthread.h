...
pthread_attr_getinheritsched (const pthread_attr_t *__restrict __attr,
			      int *__restrict __inherit) __THROW
    __nonnull ((1, 2));
...
extern int pthread_attr_setscope (pthread_attr_t *__attr, int __scope) __THROW
    __nonnull ((1));
...
extern int pthread_getattr_default_np (pthread_attr_t *__attr) __THROW
    __nonnull ((1));
...
/* Set the default attributes to be used by pthread_create in this
   process.  */
extern int pthread_setattr_default_np (const pthread_attr_t *__attr) __THROW
    __nonnull ((1));
...
extern int pthread_getname_np (pthread_t __target_thread, char *__buf,
			       size_t __buflen) __THROW __nonnull ((2));

/* Set thread name visible in the kernel and its interfaces.  */
extern int pthread_setname_np (pthread_t __target_thread,
			       const char *__name) __THROW __nonnull ((2));
#  endif
...
extern void
__pthread_unwind_next (__pthread_unwind_buf_t *__buf) __cleanup_fct_attribute
...
extern int pthread_mutex_setprioceiling (pthread_mutex_t *__restrict __mutex,
					 int __prioceiling,
					 int *__restrict __old_ceiling) __THROW
    __nonnull ((1, 3));
...
extern int __REDIRECT (pthread_cond_timedwait,
			...
			pthread_mutex_t *__restrict __mutex,
			const struct timespec *__restrict __abstime),
		       __pthread_cond_timedwait64) __nonnull ((1, 2, 3));
#    else
...
extern int __REDIRECT (pthread_cond_clockwait,
			...
			__clockid_t __clock_id,
			const struct timespec *__restrict __abstime),
		       __pthread_cond_clockwait64) __nonnull ((1, 2, 4));
#      else
