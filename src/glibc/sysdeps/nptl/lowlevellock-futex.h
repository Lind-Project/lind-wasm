...
#    define lll_futex_timed_wait(futexp, val, timeout, private)               \
      __lll_futex_syscall_with_translated_ptrs (                              \
	  4, futexp, __lll_private_flag (FUTEX_WAIT, private), val,           \
	  TRANSLATE_GUEST_POINTER_TO_HOST (timeout))
...
#    define lll_futex_wake(futexp, nr, private)                               \
      __lll_futex_syscall_with_translated_ptrs (                              \
	  4, futexp, __lll_private_flag (FUTEX_WAKE, private), nr, 0)
...
#    define lll_futex_timed_unlock_pi(futexp, private)                        \
      __lll_futex_syscall_with_translated_ptrs (                              \
	  4, futexp, __lll_private_flag (FUTEX_UNLOCK_PI, private), 0, 0)
