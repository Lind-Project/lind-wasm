...
#  define __rtld_lock_initialize(NAME)                                        \
    (void) ((NAME)                                                            \
	    = (__rtld_lock_recursive_t) _RTLD_LOCK_RECURSIVE_INITIALIZER)
...
#  if IS_IN(rtld)
#    define __rtld_lock_lock_recursive(NAME) ___rtld_mutex_lock (&(NAME).mutex)
...
libc_hidden_proto (__pthread_mutex_lock) extern int __pthread_mutex_unlock (
    pthread_mutex_t *__mutex);
...
libc_hidden_proto (__pthread_rwlock_unlock) extern int __pthread_once (
...
#    ifdef weak_extern
	...
	weak_extern (__pthread_mutexattr_destroy)
	    weak_extern (__pthread_initialize) weak_extern (__pthread_atfork)
#    else
