...
#  else
#    define PTHREAD_MUTEX_PSHARED(m)                                          \
      ((atomic_load_relaxed (&((m)->__data.__kind)) & 128) ? LLL_SHARED       \
							   : LLL_PRIVATE)
#  endif
...
#  define PTHREAD_RWLOCK_READER_OVERFLOW                                      \
    ((unsigned int) 1 << (sizeof (unsigned int) * 8 - 1))
#  define PTHREAD_RWLOCK_WRHANDOVER                                           \
    ((unsigned int) 1 << (sizeof (unsigned int) * 8 - 1))
...
libc_hidden_proto (
    __default_pthread_attr) extern int __default_pthread_attr_lock;
...
libc_hidden_proto (__sched_fifo_min_prio) extern int __sched_fifo_max_prio;
libc_hidden_proto (__sched_fifo_max_prio) extern void __init_sched_fifo_prio (
    void);
libc_hidden_proto (__init_sched_fifo_prio) extern int __pthread_tpp_change_priority (
    int prev_prio, int new_prio);
libc_hidden_proto (
    __pthread_tpp_change_priority) extern int __pthread_current_priority (void);
...
#  endif
    ;
libc_hidden_proto (__pthread_unwind) extern void __pthread_unwind_next (
    __pthread_unwind_buf_t *__buf) __cleanup_fct_attribute
...
libc_hidden_proto (__pthread_register_cancel) extern void __pthread_unregister_cancel (
    __pthread_unwind_buf_t *__buf) __cleanup_fct_attribute;
libc_hidden_proto (__pthread_unregister_cancel)

    /* Called when a thread reacts on a cancellation request.  */
    static inline void __attribute ((noreturn, always_inline))
    __do_cancel (void)
{
  ...
  __pthread_unwind (
      (__pthread_unwind_buf_t *) THREAD_GETMEM (self, cleanup_jmp_buf));
}
...
libc_hidden_proto (__nptl_free_tcb)
    ...
    int __nptl_change_stack_perm (struct pthread *pd);
...
libc_hidden_proto (__pthread_create) extern int __pthread_create_2_0 (
    pthread_t *newthread, const pthread_attr_t *attr,
    void *(*start_routine) (void *), void *arg);
extern int __pthread_attr_init (pthread_attr_t *attr);
libc_hidden_proto (__pthread_attr_init) extern int __pthread_attr_init_2_0 (
    pthread_attr_t *attr);
...
libc_hidden_proto (__nptl_create_event) libc_hidden_proto (__nptl_death_event)
...
libc_hidden_proto (
    __pthread_getschedparam) extern int __pthread_setschedparam (pthread_t
								     thread_id,
								 int policy,
								 const struct
								 sched_param
...
libc_hidden_proto (__pthread_mutex_init) extern int __pthread_mutex_destroy (
    pthread_mutex_t *__mutex);
libc_hidden_proto (__pthread_mutex_destroy) extern int __pthread_mutex_trylock (
    pthread_mutex_t *_mutex);
libc_hidden_proto (__pthread_mutex_trylock) extern int __pthread_mutex_lock (
    pthread_mutex_t *__mutex);
libc_hidden_proto (__pthread_mutex_lock) extern int __pthread_mutex_timedlock (
    pthread_mutex_t *__mutex, const struct timespec *__abstime);
extern int
__pthread_mutex_cond_lock (pthread_mutex_t *__mutex) attribute_hidden;
extern void
__pthread_mutex_cond_lock_adjust (pthread_mutex_t *__mutex) attribute_hidden;
extern int __pthread_mutex_unlock (pthread_mutex_t *__mutex);
libc_hidden_proto (__pthread_mutex_unlock) extern int __pthread_mutex_unlock_usercnt (
    pthread_mutex_t *__mutex, int __decr);
libc_hidden_proto (__pthread_mutex_unlock_usercnt) extern int __pthread_mutexattr_init (
    pthread_mutexattr_t *attr);
libc_hidden_proto (__pthread_mutexattr_init) extern int __pthread_mutexattr_destroy (
    pthread_mutexattr_t *attr);
extern int __pthread_mutexattr_settype (pthread_mutexattr_t *attr, int kind);
libc_hidden_proto (
    __pthread_mutexattr_settype) extern int __pthread_attr_destroy (pthread_attr_t
									*attr);
libc_hidden_proto (__pthread_attr_destroy) extern int __pthread_attr_getdetachstate (
...
extern int
__pthread_attr_getstackaddr (const pthread_attr_t *__restrict __attr,
			     void **__restrict __stackaddr);
extern int __pthread_attr_setstackaddr (pthread_attr_t *__attr,
					void *__stackaddr);
extern int
__pthread_attr_getstacksize (const pthread_attr_t *__restrict __attr,
...
extern int __pthread_attr_setstack (pthread_attr_t *__attr, void *__stackaddr,
				    size_t __stacksize);
int __pthread_attr_setaffinity_np (pthread_attr_t *, size_t,
				   const cpu_set_t *);
libc_hidden_proto (
    __pthread_attr_setaffinity_np) extern __typeof (pthread_getattr_default_np)
    __pthread_getattr_default_np;
libc_hidden_proto (__pthread_getattr_default_np) extern int __pthread_rwlock_init (
    pthread_rwlock_t *__restrict __rwlock,
    const pthread_rwlockattr_t *__restrict __attr);
extern int __pthread_rwlock_destroy (pthread_rwlock_t *__rwlock);
extern int __pthread_rwlock_rdlock (pthread_rwlock_t *__rwlock);
libc_hidden_proto (__pthread_rwlock_rdlock) extern int __pthread_rwlock_tryrdlock (
    pthread_rwlock_t *__rwlock);
extern int __pthread_rwlock_wrlock (pthread_rwlock_t *__rwlock);
libc_hidden_proto (__pthread_rwlock_wrlock) extern int __pthread_rwlock_trywrlock (
    pthread_rwlock_t *__rwlock);
extern int __pthread_rwlock_unlock (pthread_rwlock_t *__rwlock);
extern int __pthread_cond_broadcast (pthread_cond_t *cond);
libc_hidden_proto (
    __pthread_cond_broadcast) extern int __pthread_cond_destroy (pthread_cond_t
								     *cond);
libc_hidden_proto (__pthread_cond_destroy) extern int __pthread_cond_init (
    pthread_cond_t *cond, const pthread_condattr_t *cond_attr);
libc_hidden_proto (__pthread_cond_init) extern int __pthread_cond_signal (
    pthread_cond_t *cond);
libc_hidden_proto (__pthread_cond_signal) extern int __pthread_cond_wait (
...
#  else
    extern int __pthread_clockjoin_np64 (pthread_t threadid,
					 void **thread_return,
					 clockid_t clockid,
					 const struct __timespec64 *abstime);
libc_hidden_proto (__pthread_clockjoin_np64) extern int __pthread_timedjoin_np64 (
    pthread_t threadid, void **thread_return,
    const struct __timespec64 *abstime);
libc_hidden_proto (__pthread_timedjoin_np64) extern int __pthread_cond_timedwait64 (
    pthread_cond_t *cond, pthread_mutex_t *mutex,
    const struct __timespec64 *abstime);
libc_hidden_proto (__pthread_cond_timedwait64) extern int __pthread_cond_clockwait64 (
    pthread_cond_t *cond, pthread_mutex_t *mutex, clockid_t clockid,
    const struct __timespec64 *abstime);
libc_hidden_proto (__pthread_cond_clockwait64) extern int __pthread_rwlock_clockrdlock64 (
    pthread_rwlock_t *rwlock, clockid_t clockid,
    const struct __timespec64 *abstime);
libc_hidden_proto (__pthread_rwlock_clockrdlock64) extern int __pthread_rwlock_clockwrlock64 (
    pthread_rwlock_t *rwlock, clockid_t clockid,
    const struct __timespec64 *abstime);
libc_hidden_proto (__pthread_rwlock_clockwrlock64) extern int __pthread_rwlock_timedrdlock64 (
    pthread_rwlock_t *rwlock, const struct __timespec64 *abstime);
libc_hidden_proto (__pthread_rwlock_timedrdlock64) extern int __pthread_rwlock_timedwrlock64 (
    pthread_rwlock_t *rwlock, const struct __timespec64 *abstime);
libc_hidden_proto (__pthread_rwlock_timedwrlock64) extern int __pthread_mutex_clocklock64 (
    pthread_mutex_t *mutex, clockid_t clockid,
    const struct __timespec64 *abstime);
libc_hidden_proto (__pthread_mutex_clocklock64) extern int __pthread_mutex_timedlock64 (
    pthread_mutex_t *mutex, const struct __timespec64 *abstime);
...
libc_hidden_proto (__pthread_cond_timedwait) extern int __pthread_cond_clockwait (
    pthread_cond_t *cond, pthread_mutex_t *mutex, clockid_t clockid,
    const struct timespec *abstime) __nonnull ((1, 2, 4));
libc_hidden_proto (__pthread_cond_clockwait)

    extern int __pthread_mutex_clocklock (pthread_mutex_t *mutex,
					  clockid_t clockid,
					  const struct timespec *abstime);
libc_hidden_proto (__pthread_mutex_clocklock) extern int __pthread_mutex_timedlock (
...
libc_hidden_proto (__pthread_key_create) extern int __pthread_key_delete (
    pthread_key_t key);
libc_hidden_proto (__pthread_key_delete) extern void *__pthread_getspecific (
    pthread_key_t key);
libc_hidden_proto (__pthread_getspecific) extern int __pthread_setspecific (
    pthread_key_t key, const void *value);
libc_hidden_proto (__pthread_setspecific) extern int __pthread_once (
    pthread_once_t *once_control, void (*init_routine) (void));
libc_hidden_proto (__pthread_once) extern int __pthread_atfork (
    void (*prepare) (void), void (*parent) (void), void (*child) (void));
libc_hidden_proto (__pthread_self) extern int __pthread_equal (
    pthread_t thread1, pthread_t thread2);
extern int __pthread_detach (pthread_t th);
libc_hidden_proto (__pthread_detach) extern int __pthread_kill (
    pthread_t threadid, int signo);
libc_hidden_proto (__pthread_kill) extern int __pthread_cancel (pthread_t th);
extern int __pthread_kill_internal (pthread_t threadid,
				    int signo) attribute_hidden;
extern void __pthread_exit (void *value) __attribute__ ((__noreturn__));
libc_hidden_proto (__pthread_exit) extern int __pthread_join (
    pthread_t threadid, void **thread_return);
libc_hidden_proto (__pthread_join) extern int __pthread_setcanceltype (
    int type, int *oldtype);
libc_hidden_proto (__pthread_setcanceltype) extern void __pthread_testcancel (
    void);
libc_hidden_proto (__pthread_testcancel) extern int __pthread_clockjoin_ex (
    pthread_t, void **, clockid_t, const struct __timespec64 *,
...
#    define pthread_cleanup_combined_push(routine, arg)                       \
	...
	{                                                                     \
	  ...
	  struct __pthread_cleanup_combined_frame __clframe __attribute__ ((  \
	      __cleanup__ (__pthread_cleanup_combined_routine)))              \
...
libc_hidden_proto (__nptl_setxid_sighandler) extern int __nptl_setxid (
    struct xid_command *cmdp) attribute_hidden;
...
int __pthread_attr_extension (struct pthread_attr *attr)
    attribute_hidden __attribute_warn_unused_result__;
