...
#  define _IOT_mtpos /* Hurd ioctl type field.  */ _IOT_SIMPLE (long)
...
#  define MTIOCGETCONFIG                                                      \
    _IOR ('m', 4, struct mtconfiginfo) /* Get tape config.*/
#  define MTIOCSETCONFIG                                                      \
    _IOW ('m', 5, struct mtconfiginfo) /* Set tape config.*/
