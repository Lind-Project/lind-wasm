...
#  define __SOCKETCALL1(name, a1)                                             \
    INLINE_SYSCALL (socketcall, 2, name, ((long int[1]) { (long int) (a1) }))
...
#  define __SOCKETCALL3(name, a1, a2, a3)                                     \
    INLINE_SYSCALL (socketcall, 2, name,                                      \
		    ((long int[3]) { (long int) (a1), (long int) (a2),        \
				     (long int) (a3) }))
#  define __SOCKETCALL4(name, a1, a2, a3, a4)                                 \
    INLINE_SYSCALL (socketcall, 2, name,                                      \
		    ((long int[4]) { (long int) (a1), (long int) (a2),        \
...
#  define __SOCKETCALL6(name, a1, a2, a3, a4, a5, a6)                         \
    INLINE_SYSCALL (socketcall, 2, name,                                      \
		    ((long int[6]) { (long int) (a1), (long int) (a2),        \
				     (long int) (a3), (long int) (a4),        \
