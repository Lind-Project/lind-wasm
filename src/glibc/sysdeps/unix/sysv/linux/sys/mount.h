...
#  define MOUNT_ATTR_STRICTATIME                                              \
    0x00000020 /* - Always perform atime updates  */
...
extern int fspick (int __dfd, const char *__path,
		   unsigned int __flags) __THROW;

/* Open the mount point FILENAME in directory DFD using FLAGS.  */
extern int open_tree (int __dfd, const char *__filename,
		      unsigned int __flags) __THROW;
...
extern int mount_setattr (int __dfd, const char *__path, unsigned int __flags,
			  struct mount_attr *__uattr, size_t __usize) __THROW;
