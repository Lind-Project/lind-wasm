		     ...
		     struct __msqid64_ds *msqid64)
{
  ...
  msqid64->msg_stime
      = kmsqid->msg_stime | ((__time64_t) kmsqid->msg_stime_high << 32);
  msqid64->msg_rtime
      = kmsqid->msg_rtime | ((__time64_t) kmsqid->msg_rtime_high << 32);
  msqid64->msg_ctime
      = kmsqid->msg_ctime | ((__time64_t) kmsqid->msg_ctime_high << 32);
...
libc_hidden_def (__msgctl64)
    ...
    static void msqid_to_msqid64 (struct __msqid64_ds *mq64,
				  const struct msqid_ds *mq)
{
  mq64->msg_perm = mq->msg_perm;
  mq64->msg_stime = mq->msg_stime | ((__time64_t) mq->__msg_stime_high << 32);
  mq64->msg_rtime = mq->msg_rtime | ((__time64_t) mq->__msg_rtime_high << 32);
  mq64->msg_ctime = mq->msg_ctime | ((__time64_t) mq->__msg_ctime_high << 32);
...
struct __old_msqid_ds
{
  struct __old_ipc_perm
      msg_perm;		      /* structure describing operation permission */
