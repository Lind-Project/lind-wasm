...
#    define SYSCALL_INST5                                                     \
      mov.l @(0, r15), r0;                                                    \
      trapa #0x15
#    define SYSCALL_INST6                                                     \
      mov.l @(0, r15), r0;                                                    \
      mov.l @(4, r15), r1;                                                    \
      trapa #0x16
...
#    define SUBSTITUTE_ARGS_1(arg1)                                           \
      ...
      register long int r4 = (long int) (_arg1)
#    define SUBSTITUTE_ARGS_2(arg1, arg2)                                     \
      long int _arg1 = (long int) (arg1);                                     \
      long int _arg2 = (long int) (arg2);                                     \
      register long int r4 = (long int) (_arg1);                              \
      register long int r5 = (long int) (_arg2)
#    define SUBSTITUTE_ARGS_3(arg1, arg2, arg3)                               \
      ...
      register long int r4 = (long int) (_arg1);                              \
      register long int r5 = (long int) (_arg2);                              \
      register long int r6 = (long int) (_arg3)
#    define SUBSTITUTE_ARGS_4(arg1, arg2, arg3, arg4)                         \
      ...
      register long int r5 = (long int) (_arg2);                              \
      register long int r6 = (long int) (_arg3);                              \
      register long int r7 = (long int) (_arg4)
#    define SUBSTITUTE_ARGS_5(arg1, arg2, arg3, arg4, arg5)                   \
      ...
      register long int r6 = (long int) (_arg3);                              \
      register long int r7 = (long int) (_arg4);                              \
      register long int r0 = (long int) (_arg5)
#    define SUBSTITUTE_ARGS_6(arg1, arg2, arg3, arg4, arg5, arg6)             \
      ...
      register long int r7 = (long int) (_arg4);                              \
      register long int r0 = (long int) (_arg5);                              \
      register long int r1 = (long int) (_arg6)
#    define SUBSTITUTE_ARGS_7(arg1, arg2, arg3, arg4, arg5, arg6, arg7)       \
      ...
      register long int r0 = (long int) (_arg5);                              \
      register long int r1 = (long int) (_arg6);                              \
      register long int r2 = (long int) (_arg7)

#    undef INTERNAL_SYSCALL
#    define INTERNAL_SYSCALL(name, nr, args...)                               \
      ({                                                                      \
	unsigned long int resultvar;                                          \
	register long int r3 = SYS_ify (name);                                \
