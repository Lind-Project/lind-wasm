...
#	define SYSCALL_ERROR_HANDLER(name)                                   \
	  .Lsyscall_error##name : li t1, -4096;                               \
	  neg a0, a0;                                                         \
	  sw a0, rtld_errno, t1;                                              \
	  li a0, -1;
#      elif defined(__PIC__)
#	define SYSCALL_ERROR_HANDLER(name)                                   \
	  .Lsyscall_error##name : la.tls.ie t1, errno;                        \
	  add t1, t1, tp;                                                     \
	  neg a0, a0;                                                         \
	  sw a0, 0(t1);                                                       \
	  li a0, -1;
#      else
#	define SYSCALL_ERROR_HANDLER(name)                                   \
	  .Lsyscall_error##name : lui t1, % tprel_hi (errno);                 \
...
#    else
#      define SYSCALL_ERROR_HANDLER(name)                                     \
	.Lsyscall_error##name : tail __syscall_error;
#    endif
...
#    define internal_syscall0(number, dummy...)                               \
	...
	long int _sys_result;                                                 \
                                                                              \
	{                                                                     \
	  register long int __a7 = number;                                    \
	  register long int __a0;                                             \
	  _sys_result = __a0;                                                 \
	}                                                                     \
	_sys_result;                                                          \
      })
...
#    define internal_syscall6(number, arg0, arg1, arg2, arg3, arg4, arg5)     \
	...
	{                                                                     \
	  ...
	  register long int __a3 = _arg3;                                     \
	  register long int __a4 = _arg4;                                     \
	  register long int __a5 = _arg5;                                     \
	  _sys_result = __a0;                                                 \
	}                                                                     \
	_sys_result;                                                          \
      })

#    define internal_syscall7(number, arg0, arg1, arg2, arg3, arg4, arg5,     \
			      arg6)                                           \
      ({                                                                      \
	long int _sys_result;                                                 \
	long int _arg0 = (long int) (arg0);                                   \
