...
#	define SYSCALL_ERROR_HANDLER                                         \
	  .Lsyscall_error : adrp x1, C_SYMBOL_NAME (rtld_errno);              \
	  neg w0, w0;                                                         \
...
#	define SYSCALL_ERROR_HANDLER                                         \
	  .Lsyscall_error : adrp x1, : gottprel : errno;                      \
	  neg w2, w0;                                                         \
...
#      define SYSCALL_ERROR_HANDLER .Lsyscall_error : b __syscall_error;
#    endif
...
#    define INTERNAL_SYSCALL_RAW(name, nr, args...)                           \
	...
	long _sys_result;                                                     \
	{                                                                     \
	  LOAD_ARGS_##nr (args) register long _x8 = (name);                   \
	  _sys_result = _x0;                                                  \
	}                                                                     \
	_sys_result;                                                          \
      })
...
#    define LOAD_ARGS_0() register long _x0;
