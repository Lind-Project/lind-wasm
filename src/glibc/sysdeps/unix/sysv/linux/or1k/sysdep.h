...
#    define PSEUDO_END(name)                                                  \
      L (pseudo_end) : l.j SYSCALL_ERROR_NAME;                                \
      l.ori r3, r11, 0;                                                       \
      END (name)
...
#    define INTERNAL_SYSCALL_NCS(number, nr, args...)                         \
	...
	{                                                                     \
	  ...
	  LOAD_ARGS_##nr (args) register long int __sc_ret = _sc_ret;         \
