...
#define RESTORE2(name, syscall)                                                                                                                                                                                                                                                                   \
  asm (/* `nop' for debuggers assuming `call' should not disalign the code.                                                                                                                                                                                                                       \
	*/                                                                                                                                                                                                                                                                                        \
       "	nop\n"                                                                                                                                                                                                                                                                                   \
       ".align 16\n"                                                                                                                                                                                                                                                                              \
       ".LSTART_" #name ":\n"                                                                                                                                                                                                                                                                     \
       ...
       "	.uleb128 16\n" /* Return address register column (rip) */ /* Augmentation value length */                                                                                                                                                                                         \
       ...
       "\n" /* CIE */ /* `LSTART_' is subtracted 1 as debuggers assume a                                                                                                                                                                                                                          \
			 `call' here.  */                                                                                                                                                                                                                                                         \
       "	.long (.LSTART_" #name                                                                                                                                                                                                                                                            \
       "-1)-.\n" /* PC-relative start addr.  */                                                                                                                                                                                                                                                   \
       "	.long .LEND_" #name "-(.LSTART_" #name "-1)\n"                                                                                                                                                                                                                                    \
       "	.uleb128 0\n" /* FDE augmentation length */                                                                                                                                                                                                                                       \
       do_cfa_expr do_expr (8 /* r8 */, oR8) do_expr (9 /* r9 */, oR9)                                                                                                                                                                                                                            \
	   do_expr (10 /* r10 */, oR10) do_expr (11 /* r11 */, oR11)                                                                                                                                                                                                                              \
	       do_expr (12 /* r12 */, oR12) do_expr (13 /* r13 */, oR13)                                                                                                                                                                                                                          \
		   do_expr (14 /* r14 */, oR14) do_expr (15 /* r15 */, oR15)                                                                                                                                                                                                                      \
		       do_expr (5 /* rdi */, oRDI) do_expr (                                                                                                                                                                                                                                      \
			   4 /* rsi */, oRSI) do_expr (6 /* rbp */, oRBP)                                                                                                                                                                                                                         \
			   do_expr (3 /* rbx */, oRBX) do_expr (1 /* rdx */,                                                                                                                                                                                                                      \
								oRDX)                                                                                                                                                                                                                             \
			       do_expr (0 /* rax */, oRAX)                                                                                                                                                                                                                                        \
				   do_expr (2 /* rcx */, oRCX) do_expr (                                                                                                                                                                                                                          \
				       7 /* rsp */,                                                                                                                                                                                                                                               \
				       oRSP) do_expr (16 /* rip */, oRIP) /* libgcc-4.1.1 has only `DWARF_FRAME_REGISTERS == 17'.  */ /* do_expr (49 |* rflags *|, oEFL) */ /* `cs'/`ds'/`fs' are unaligned and a different size.  */ /* gas: Error: register save offset not a multiple of 8  */ \
       "	.align " LP_SIZE "\n"                                                                                                                                                                                                                                                             \
       ".LENDFDE_" #name ":\n"                                                                                                                                                                                                                                                                    \
       "	.previous\n");
