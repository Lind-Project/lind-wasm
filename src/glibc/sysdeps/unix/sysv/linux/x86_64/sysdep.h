...
#    if SYSCALL_ULONG_ARG_1
#      define PSEUDO_NOERRNO(name, syscall_name, args, ulong_arg_1,           \
			     ulong_arg_2)                                     \
	.text;                                                                \
	ENTRY (name)                                                          \
	DO_CALL (syscall_name, args, ulong_arg_1, ulong_arg_2)
...
#    undef PSEUDO_ERRVAL
#    if SYSCALL_ULONG_ARG_1
#      define PSEUDO_ERRVAL(name, syscall_name, args, ulong_arg_1,            \
			    ulong_arg_2)                                      \
	.text;                                                                \
	ENTRY (name)                                                          \
	DO_CALL (syscall_name, args, ulong_arg_1, ulong_arg_2);               \
...
#    define DO_CALL(syscall_name, args, ulong_arg_1, ulong_arg_2)             \
      DOARGS_##args ZERO_EXTEND_##ulong_arg_1 ZERO_EXTEND_##ulong_arg_2 movl  \
	  $SYS_ify (syscall_name),                                            \
	  % eax;                                                              \
      syscall;
