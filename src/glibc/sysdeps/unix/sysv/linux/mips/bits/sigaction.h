...
#  define SA_SIGINFO                                                          \
    0x00000008 /* Invoke signal-catching function with                        \
		  three arguments instead of one.  */
#  if defined __USE_XOPEN_EXTENDED || defined __USE_MISC
#    define SA_ONSTACK                                                        \
      0x08000000 /* Use signal stack by using `sa_restorer'. */
#  endif
#  if defined __USE_XOPEN_EXTENDED || defined __USE_XOPEN2K8
#    define SA_RESETHAND                                                      \
      0x80000000		  /* Reset to SIG_DFL on entry to handler.  */
...
#  ifdef __USE_MISC
#    define SIG_SETMASK32                                                     \
      256 /* Goodie from SGI for BSD compatibility:                           \
