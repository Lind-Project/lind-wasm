...
#  define __mips16_syscall4(a0, a1, a2, a3, number)                           \
    __mips16_syscall4 ((long int) (a0), (long int) (a1), (long int) (a2),     \
		       (long int) (a3), (long int) (number))

/* The remaining ones use regular MIPS wrappers.  */

#  define __mips16_syscall5(a0, a1, a2, a3, a4, number)                       \
    __mips_syscall5 ((long int) (a0), (long int) (a1), (long int) (a2),       \
		     (long int) (a3), (long int) (a4), (long int) (number))

#  define __mips16_syscall6(a0, a1, a2, a3, a4, a5, number)                   \
    __mips_syscall6 ((long int) (a0), (long int) (a1), (long int) (a2),       \
		     (long int) (a3), (long int) (a4), (long int) (a5),       \
		     (long int) (number))

#  define __mips16_syscall7(a0, a1, a2, a3, a4, a5, a6, number)               \
    __mips_syscall7 ((long int) (a0), (long int) (a1), (long int) (a2),       \
		     (long int) (a3), (long int) (a4), (long int) (a5),       \
		     (long int) (a6), (long int) (number))
