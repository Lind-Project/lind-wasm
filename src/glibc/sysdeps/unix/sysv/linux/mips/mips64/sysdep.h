...
#    define internal_syscall0(v0_init, input, number, dummy...)               \
	...
	long int _sys_result;                                                 \
                                                                              \
	{                                                                     \
	  register __syscall_arg_t __s0 __attribute__ ((unused)) = (number);  \
	  register __syscall_arg_t __v0;                                      \
	  register __syscall_arg_t __a3;                                      \
...
#    define internal_syscall1(v0_init, input, number, arg1)                   \
	...
	{                                                                     \
	  ...
	  register __syscall_arg_t __s0 __attribute__ ((unused)) = (number);  \
	  register __syscall_arg_t __v0;                                      \
	  register __syscall_arg_t __a0 = _arg1;                              \
	  register __syscall_arg_t __a3;                                      \
	  _sys_result = __a3 != 0 ? -__v0 : __v0;                             \
	}                                                                     \
	_sys_result;                                                          \
...
#    define internal_syscall2(v0_init, input, number, arg1, arg2)             \
	...
	{                                                                     \
	  ...
	  register __syscall_arg_t __v0;                                      \
	  register __syscall_arg_t __a0 = _arg1;                              \
	  register __syscall_arg_t __a1 = _arg2;                              \
	  register __syscall_arg_t __a3;                                      \
	  _sys_result = __a3 != 0 ? -__v0 : __v0;                             \
	}                                                                     \
	_sys_result;                                                          \
...
#    define internal_syscall3(v0_init, input, number, arg1, arg2, arg3)       \
	...
	{                                                                     \
	  ...
	  register __syscall_arg_t __a0 = _arg1;                              \
	  register __syscall_arg_t __a1 = _arg2;                              \
	  register __syscall_arg_t __a2 = _arg3;                              \
	  register __syscall_arg_t __a3;                                      \
	  _sys_result = __a3 != 0 ? -__v0 : __v0;                             \
	}                                                                     \
	_sys_result;                                                          \
...
#    define internal_syscall4(v0_init, input, number, arg1, arg2, arg3, arg4) \
	...
	{                                                                     \
	  ...
	  register __syscall_arg_t __a1 = _arg2;                              \
	  register __syscall_arg_t __a2 = _arg3;                              \
	  register __syscall_arg_t __a3 = _arg4;                              \
	  _sys_result = __a3 != 0 ? -__v0 : __v0;                             \
	}                                                                     \
	_sys_result;                                                          \
      })

#    define internal_syscall5(v0_init, input, number, arg1, arg2, arg3, arg4, \
			      arg5)                                           \
      ({                                                                      \
	long int _sys_result;                                                 \
                                                                              \
	{                                                                     \
	  ...
	  register __syscall_arg_t __a2 = _arg3;                              \
	  register __syscall_arg_t __a3 = _arg4;                              \
	  register __syscall_arg_t __a4 = _arg5;                              \
	  _sys_result = __a3 != 0 ? -__v0 : __v0;                             \
	}                                                                     \
	_sys_result;                                                          \
      })

#    define internal_syscall6(v0_init, input, number, arg1, arg2, arg3, arg4, \
			      arg5, arg6)                                     \
      ({                                                                      \
	long int _sys_result;                                                 \
                                                                              \
	{                                                                     \
	  ...
	  register __syscall_arg_t __a3 = _arg4;                              \
	  register __syscall_arg_t __a4 = _arg5;                              \
	  register __syscall_arg_t __a5 = _arg6;                              \
	  _sys_result = __a3 != 0 ? -__v0 : __v0;                             \
	}                                                                     \
	_sys_result;                                                          \
      })
