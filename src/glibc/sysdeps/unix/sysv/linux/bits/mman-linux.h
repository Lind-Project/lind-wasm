...
#ifndef _SYS_MMAN_H
#  error                                                                       \
      "Never use <bits/mman-linux.h> directly; include <sys/mman.h> instead."
#endif
...
#  define MADV_DONTDUMP                                                       \
    16			     /* Explicitly exclude from the core dump,        \
...
#  define MADV_POPULATE_READ                                                  \
    22 /* Populate (prefault) page tables                                     \
	  readable.  */
#  define MADV_POPULATE_WRITE                                                 \
    23 /* Populate (prefault) page tables                                     \
	  writable.  */
#  define MADV_DONTNEED_LOCKED                                                \
    24			    /* Like MADV_DONTNEED, but drop                   \
			       locked pages too.  */
