...
/* If the application has already included linux/in6.h from a linux-based
   ...
   Neither the linux kernel nor glibc should break this ABI without
   coordination. In upstream kernel 56c176c9 the _UAPI prefix was stripped so
   we need to check for _LINUX_IN6_H and _IPV6_H now, and keep checking the old
   versions for maximum backwards compatibility.  */
#if defined _UAPI_LINUX_IN6_H || defined _UAPI_IPV6_H || defined _LINUX_IN6_H \
    || defined _IPV6_H
...
#  define MCAST_UNBLOCK_SOURCE                                                \
    44			       /* group_source_req: unblock from given group*/
#  define MCAST_LEAVE_GROUP 45 /* group_req: leave any-source group */
#  define MCAST_JOIN_SOURCE_GROUP                                             \
    46 /* group_source_req: join source-spec gr */
#  define MCAST_LEAVE_SOURCE_GROUP                                            \
    47 /* group_source_req: leave source-spec gr*/
