...
#	define SYSCALL_ERROR_HANDLER                                         \
	  0 : SETUP_PIC_REG_LEAF (o2, g1) sethi % gdop_hix22 (rtld_errno),    \
	      % g1;                                                           \
...
#	endif
#	define SYSCALL_ERROR_HANDLER                                         \
	  0 : SETUP_PIC_REG_LEAF (o2, g1) sethi                               \
	      % tie_hi22 (SYSCALL_ERROR_ERRNO),                               \
	      % g1;                                                           \
...
#      else
#	define SYSCALL_ERROR_HANDLER                                         \
	  0 : SETUP_PIC_REG_LEAF (o2, g1) sethi % gdop_hix22 (errno), % g1;   \
...
#    define __SYSCALL_CLOBBERS                                                \
	  ...
	  "f29", "f30", "f31", "f32", "f34", "f36", "f38", "f40", "f42",      \
	  "f44", "f46", "f48", "f50", "f52", "f54", "f56", "f58", "f60",      \
	  "f62", "cc", "memory"
