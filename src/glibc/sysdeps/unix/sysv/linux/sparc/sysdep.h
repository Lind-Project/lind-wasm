...
#    define internal_syscall0(string, name, dummy...)                         \
      ({                                                                      \
	register long int __g1 = (name);                                      \
	register long __o0;                                                   \
	__asm __volatile (string                                              \
			  : "=r"(__o0)                                        \
			  : "r"(__g1)                                         \
			  : __SYSCALL_CLOBBERS);                              \
	__o0;                                                                 \
...
#    define internal_syscall3(string, name, arg1, arg2, arg3)                 \
	...
	register long int __o0 = _arg1;                                       \
	register long int __o1 = _arg2;                                       \
	register long int __o2 = _arg3;                                       \
	__asm __volatile (string                                              \
			  : "=r"(__o0)                                        \
			  : "r"(__g1), "0"(__o0), "r"(__o1), "r"(__o2)        \
			  : __SYSCALL_CLOBBERS);                              \
	__o0;                                                                 \
      })
...
#    define internal_syscall6(string, name, arg1, arg2, arg3, arg4, arg5,     \
			      arg6)                                           \
      ({                                                                      \
	long int _arg1 = (long int) (arg1);                                   \
	long int _arg2 = (long int) (arg2);                                   \
...
#    define INLINE_CLONE_SYSCALL(arg1, arg2, arg3, arg4, arg5)                \
	...
	register long int __o3 = _arg4;                                       \
	register long int __o4 = _arg5;                                       \
	register long int __g1 = __NR_clone;                                  \
	__asm __volatile (__SYSCALL_STRING                                    \
			  : "=r"(__o0), "=r"(__o1)                            \
			  : "r"(__g1), "0"(__o0), "1"(__o1), "r"(__o2),       \
			    "r"(__o3), "r"(__o4)                              \
			  : __SYSCALL_CLOBBERS);                              \
