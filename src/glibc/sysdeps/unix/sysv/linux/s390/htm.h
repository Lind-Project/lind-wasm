...
#  define __libc_tbegin_retry_abort_path_insn                                       \
    ...
    "   jnh 1f\n\t" /* cc 1/3: jump to fallback path.  */ /* tbegin returned        \
...
#  define __libc_tbegin_retry(tdb, retry_cnt)                                 \
    ({                                                                        \
      ...
      int __tx_cnt = 0;                                                       \
      __ret                                                                   \
	  = __libc_tbegin_base (tdb, __libc_tbegin_retry_abort_path_insn,     \
...
#  define __libc_tabort(abortcode) __builtin_tabort (abortcode);
