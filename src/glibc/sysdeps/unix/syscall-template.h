...
#define MAKE_SYSCALL6(syscallnum, callname, arg1, arg2, arg3, arg4, arg5,     \
		      arg6)                                                   \
  lind_syscall (syscallnum, (unsigned long long) (callname),                  \
...
#define MAKE_SYSCALL5(syscallnum, callname, arg1, arg2, arg3, arg4, arg5)     \
  lind_syscall (syscallnum, (unsigned long long) (callname),                  \
		(unsigned long long) (arg1), (unsigned long long) (arg2),     \
		(unsigned long long) (arg3), (unsigned long long) (arg4),     \
		(unsigned long long) (arg5), (unsigned long long) (NOTUSED),  \
		WARPPED_SYSCALL)
...
#define MAKE_SYSCALL4(syscallnum, callname, arg1, arg2, arg3, arg4)           \
  lind_syscall (syscallnum, (unsigned long long) (callname),                  \
		(unsigned long long) (arg1), (unsigned long long) (arg2),     \
		(unsigned long long) (arg3), (unsigned long long) (arg4),     \
		(unsigned long long) (NOTUSED),                               \
		(unsigned long long) (NOTUSED), WARPPED_SYSCALL)

#define MAKE_SYSCALL3(syscallnum, callname, arg1, arg2, arg3)                 \
  lind_syscall (syscallnum, (unsigned long long) (callname),                  \
		(unsigned long long) (arg1), (unsigned long long) (arg2),     \
		(unsigned long long) (arg3), (unsigned long long) (NOTUSED),  \
		(unsigned long long) (NOTUSED),                               \
		(unsigned long long) (NOTUSED), WARPPED_SYSCALL)
...
#define MAKE_SYSCALL1(syscallnum, callname, arg1)                             \
  lind_syscall (syscallnum, (unsigned long long) (callname),                  \
		(unsigned long long) (arg1), (unsigned long long) (NOTUSED),  \
		(unsigned long long) (NOTUSED),                               \
		(unsigned long long) (NOTUSED),                               \
		(unsigned long long) (NOTUSED),                               \
		(unsigned long long) (NOTUSED), WARPPED_SYSCALL)
...
#define MAKE_SYSCALL0(syscallnum, callname)                                   \
  lind_syscall (                                                              \
      syscallnum, (unsigned long long) (callname),                            \
      (unsigned long long) (NOTUSED), (unsigned long long) (NOTUSED),         \
      (unsigned long long) (NOTUSED), (unsigned long long) (NOTUSED),         \
      (unsigned long long) (NOTUSED), (unsigned long long) (NOTUSED),         \
      WARPPED_SYSCALL)
...
#define MAKE_RAW_SYSCALL6(syscallnum, callname, arg1, arg2, arg3, arg4, arg5, \
			  arg6)                                               \
  lind_syscall (syscallnum, (unsigned long long) (callname),                  \
		(unsigned long long) (arg1), (unsigned long long) (arg2),     \
		(unsigned long long) (arg3), (unsigned long long) (arg4),     \
...
#define MAKE_RAW_SYSCALL4(syscallnum, callname, arg1, arg2, arg3, arg4)       \
  lind_syscall (syscallnum, (unsigned long long) (callname),                  \
		...
		(unsigned long long) (arg3), (unsigned long long) (arg4),     \
		(unsigned long long) (NOTUSED),                               \
		(unsigned long long) (NOTUSED), RAW_SYSCALL)
...
#define REGISTER_HANDLER_SYSCALL(                                             \
...
#define CP_DATA_SYSCALL(thiscage, targetcage, srcaddr, srccage, destaddr,     \
			destcage, len, copytype)                              \
  lind_cp_data ((uint64_t) thiscage, (uint64_t) targetcage,                   \
