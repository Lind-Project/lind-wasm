...
#endif
	      IFUNC_IMPL_ADD (array, i, strcpy, SUPPORT_UAL,
			      __strcpy_unaligned)
...
#endif
	      IFUNC_IMPL_ADD (array, i, stpcpy, SUPPORT_UAL,
			      __stpcpy_unaligned)
...
#endif
	      IFUNC_IMPL_ADD (array, i, memcpy, SUPPORT_UAL,
			      __memcpy_unaligned)
...
#endif
	      IFUNC_IMPL_ADD (array, i, memmove, SUPPORT_UAL,
			      __memmove_unaligned)
...
#endif
	      IFUNC_IMPL_ADD (array, i, memset, SUPPORT_UAL,
			      __memset_unaligned)
