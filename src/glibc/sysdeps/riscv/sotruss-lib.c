...
ElfW (Addr) la_riscv_gnu_pltenter (ElfW (Sym) * sym __attribute__ ((unused)),
...
la_riscv_gnu_pltexit (ElfW (Sym) * sym, unsigned int ndx, uintptr_t *refcook,
		      uintptr_t *defcook, const struct La_riscv_regs *inregs,
		      struct La_riscv_retval *outregs, const char *symname)
{
