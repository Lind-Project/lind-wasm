...
#  define ELF_MACHINE_XHASH_SETUP(hash32, symbias, map)                       \
    do                                                                        \
      {                                                                       \
	(hash32)                                                              \
	    += (map)->l_info[DT_MIPS (SYMTABNO)]->d_un.d_val - (symbias);     \
...
#  define ELF64_MIPS_R_TYPE(i)                                                \
    (((_Elf64_Mips_R_Info_union) (i)).r_info_fields.r_type1                   \
     | ((Elf32_Word) (__extension__ (_Elf64_Mips_R_Info_union) (i))           \
	    .r_info_fields.r_type2                                            \
	<< 8)                                                                 \
     | ((Elf32_Word) (__extension__ (_Elf64_Mips_R_Info_union) (i))           \
	    .r_info_fields.r_type3                                            \
	<< 16)                                                                \
     | ((Elf32_Word) (__extension__ (_Elf64_Mips_R_Info_union) (i))           \
	    .r_info_fields.r_ssym                                             \
	<< 24))
#  define ELF64_MIPS_R_INFO(sym, type)                                        \
    (__extension__ (_Elf64_Mips_R_Info_union) (                               \
	 __extension__ (_Elf64_Mips_R_Info){                                  \
	     (sym), ELF64_MIPS_R_SSYM (type), ELF64_MIPS_R_TYPE3 (type),      \
...
#  define ELF64_MIPS_R_TYPEENC(type1, type2, type3, ssym)                     \
    ((type1) | ((Elf32_Word) (type2) << 8) | ((Elf32_Word) (type3) << 16)     \
     | ((Elf32_Word) (ssym) << 24))
