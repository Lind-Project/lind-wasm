			...
			size_t max)
{
  ...
  IFUNC_IMPL (
      i, name, memset,
#  if HAVE_MEMSET_Z196
      IFUNC_IMPL_ADD (array, i, memset, S390_IS_Z196 (stfle_bits), MEMSET_Z196)
#  endif
#  if HAVE_MEMSET_Z10
	  IFUNC_IMPL_ADD (array, i, memset, S390_IS_Z10 (stfle_bits),
			  MEMSET_Z10)
#  endif
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, memcmp,
#  if HAVE_MEMCMP_Z196
      IFUNC_IMPL_ADD (array, i, memcmp, S390_IS_Z196 (stfle_bits), MEMCMP_Z196)
#  endif
#  if HAVE_MEMCMP_Z10
	  IFUNC_IMPL_ADD (array, i, memcmp, S390_IS_Z10 (stfle_bits),
			  MEMCMP_Z10)
#  endif
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, memcpy,
#  if HAVE_MEMCPY_Z196
      IFUNC_IMPL_ADD (array, i, memcpy, S390_IS_Z196 (stfle_bits), MEMCPY_Z196)
#  endif
#  if HAVE_MEMCPY_Z10
	  IFUNC_IMPL_ADD (array, i, memcpy, S390_IS_Z10 (stfle_bits),
			  MEMCPY_Z10)
#  endif
...
#  if HAVE_MEMCPY_Z196
	      IFUNC_IMPL_ADD (array, i, mempcpy, S390_IS_Z196 (stfle_bits),
			      MEMPCPY_Z196)
#  endif
#  if HAVE_MEMCPY_Z10
		  IFUNC_IMPL_ADD (array, i, mempcpy, S390_IS_Z10 (stfle_bits),
				  MEMPCPY_Z10)
#  endif
#  if HAVE_MEMCPY_Z900_G5
...
#  endif
#  if HAVE_MEMMOVE_Z13
		  IFUNC_IMPL_ADD (array, i, memmove, dl_hwcap & HWCAP_S390_VX,
				  MEMMOVE_Z13)
#  endif
#  if HAVE_MEMMOVE_C
...
#  endif
#  if HAVE_STRSTR_Z13
		  IFUNC_IMPL_ADD (array, i, strstr, dl_hwcap & HWCAP_S390_VX,
				  STRSTR_Z13)
#  endif
#  if HAVE_STRSTR_C
...
#  endif
#  if HAVE_MEMMEM_Z13
		  IFUNC_IMPL_ADD (array, i, memmem, dl_hwcap & HWCAP_S390_VX,
				  MEMMEM_Z13)
#  endif
#  if HAVE_MEMMEM_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strlen,
#  if HAVE_STRLEN_Z13
      IFUNC_IMPL_ADD (array, i, strlen, dl_hwcap & HWCAP_S390_VX, STRLEN_Z13)
#  endif
#  if HAVE_STRLEN_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strnlen,
#  if HAVE_STRNLEN_Z13
      IFUNC_IMPL_ADD (array, i, strnlen, dl_hwcap & HWCAP_S390_VX, STRNLEN_Z13)
#  endif
#  if HAVE_STRNLEN_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strcpy,
#  if HAVE_STRCPY_Z13
      IFUNC_IMPL_ADD (array, i, strcpy, dl_hwcap & HWCAP_S390_VX, STRCPY_Z13)
#  endif
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, stpcpy,
#  if HAVE_STPCPY_Z13
      IFUNC_IMPL_ADD (array, i, stpcpy, dl_hwcap & HWCAP_S390_VX, STPCPY_Z13)
#  endif
#  if HAVE_STPCPY_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strncpy,
#  if HAVE_STRNCPY_Z13
      IFUNC_IMPL_ADD (array, i, strncpy, dl_hwcap & HWCAP_S390_VX, STRNCPY_Z13)
#  endif
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, stpncpy,
#  if HAVE_STPNCPY_Z13
      IFUNC_IMPL_ADD (array, i, stpncpy, dl_hwcap & HWCAP_S390_VX, STPNCPY_Z13)
#  endif
#  if HAVE_STPNCPY_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strcat,
#  if HAVE_STRCAT_Z13
      IFUNC_IMPL_ADD (array, i, strcat, dl_hwcap & HWCAP_S390_VX, STRCAT_Z13)
#  endif
#  if HAVE_STRCAT_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strncat,
#  if HAVE_STRNCAT_Z13
      IFUNC_IMPL_ADD (array, i, strncat, dl_hwcap & HWCAP_S390_VX, STRNCAT_Z13)
#  endif
#  if HAVE_STRNCAT_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strcmp,
#  if HAVE_STRCMP_Z13
      IFUNC_IMPL_ADD (array, i, strcmp, dl_hwcap & HWCAP_S390_VX, STRCMP_Z13)
#  endif
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strncmp,
#  if HAVE_STRNCMP_Z13
      IFUNC_IMPL_ADD (array, i, strncmp, dl_hwcap & HWCAP_S390_VX, STRNCMP_Z13)
#  endif
#  if HAVE_STRNCMP_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strchr,
#  if HAVE_STRCHR_Z13
      IFUNC_IMPL_ADD (array, i, strchr, dl_hwcap & HWCAP_S390_VX, STRCHR_Z13)
#  endif
#  if HAVE_STRCHR_C
...
#  if HAVE_STRCHRNUL_Z13
	      IFUNC_IMPL_ADD (array, i, strchrnul, dl_hwcap & HWCAP_S390_VX,
			      STRCHRNUL_Z13)
#  endif
#  if HAVE_STRCHRNUL_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strrchr,
#  if HAVE_STRRCHR_Z13
      IFUNC_IMPL_ADD (array, i, strrchr, dl_hwcap & HWCAP_S390_VX, STRRCHR_Z13)
#  endif
#  if HAVE_STRRCHR_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strspn,
#  if HAVE_STRSPN_Z13
      IFUNC_IMPL_ADD (array, i, strspn, dl_hwcap & HWCAP_S390_VX, STRSPN_Z13)
#  endif
#  if HAVE_STRSPN_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strpbrk,
#  if HAVE_STRPBRK_Z13
      IFUNC_IMPL_ADD (array, i, strpbrk, dl_hwcap & HWCAP_S390_VX, STRPBRK_Z13)
#  endif
#  if HAVE_STRPBRK_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, strcspn,
#  if HAVE_STRCSPN_Z13
      IFUNC_IMPL_ADD (array, i, strcspn, dl_hwcap & HWCAP_S390_VX, STRCSPN_Z13)
#  endif
#  if HAVE_STRCSPN_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, memchr,
#  if HAVE_MEMCHR_Z13
      IFUNC_IMPL_ADD (array, i, memchr, dl_hwcap & HWCAP_S390_VX, MEMCHR_Z13)
#  endif
...
#  if HAVE_RAWMEMCHR_Z13
	      IFUNC_IMPL_ADD (array, i, rawmemchr, dl_hwcap & HWCAP_S390_VX,
			      RAWMEMCHR_Z13)
#  endif
#  if HAVE_RAWMEMCHR_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, memccpy,
#  if HAVE_MEMCCPY_Z13
      IFUNC_IMPL_ADD (array, i, memccpy, dl_hwcap & HWCAP_S390_VX, MEMCCPY_Z13)
#  endif
#  if HAVE_MEMCCPY_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, memrchr,
#  if HAVE_MEMRCHR_Z13
      IFUNC_IMPL_ADD (array, i, memrchr, dl_hwcap & HWCAP_S390_VX, MEMRCHR_Z13)
#  endif
#  if HAVE_MEMRCHR_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcslen,
#  if HAVE_WCSLEN_Z13
      IFUNC_IMPL_ADD (array, i, wcslen, dl_hwcap & HWCAP_S390_VX, WCSLEN_Z13)
#  endif
#  if HAVE_WCSLEN_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcsnlen,
#  if HAVE_WCSNLEN_Z13
      IFUNC_IMPL_ADD (array, i, wcsnlen, dl_hwcap & HWCAP_S390_VX, WCSNLEN_Z13)
#  endif
#  if HAVE_WCSNLEN_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcscpy,
#  if HAVE_WCSCPY_Z13
      IFUNC_IMPL_ADD (array, i, wcscpy, dl_hwcap & HWCAP_S390_VX, WCSCPY_Z13)
#  endif
#  if HAVE_WCSCPY_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcpcpy,
#  if HAVE_WCPCPY_Z13
      IFUNC_IMPL_ADD (array, i, wcpcpy, dl_hwcap & HWCAP_S390_VX, WCPCPY_Z13)
#  endif
#  if HAVE_WCPCPY_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcsncpy,
#  if HAVE_WCSNCPY_Z13
      IFUNC_IMPL_ADD (array, i, wcsncpy, dl_hwcap & HWCAP_S390_VX, WCSNCPY_Z13)
#  endif
#  if HAVE_WCSNCPY_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcpncpy,
#  if HAVE_WCPNCPY_Z13
      IFUNC_IMPL_ADD (array, i, wcpncpy, dl_hwcap & HWCAP_S390_VX, WCPNCPY_Z13)
#  endif
#  if HAVE_WCPNCPY_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcscat,
#  if HAVE_WCSCAT_Z13
      IFUNC_IMPL_ADD (array, i, wcscat, dl_hwcap & HWCAP_S390_VX, WCSCAT_Z13)
#  endif
#  if HAVE_WCSCAT_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcsncat,
#  if HAVE_WCSNCAT_Z13
      IFUNC_IMPL_ADD (array, i, wcsncat, dl_hwcap & HWCAP_S390_VX, WCSNCAT_Z13)
#  endif
#  if HAVE_WCSNCAT_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcscmp,
#  if HAVE_WCSCMP_Z13
      IFUNC_IMPL_ADD (array, i, wcscmp, dl_hwcap & HWCAP_S390_VX, WCSCMP_Z13)
#  endif
#  if HAVE_WCSCMP_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcsncmp,
#  if HAVE_WCSNCMP_Z13
      IFUNC_IMPL_ADD (array, i, wcsncmp, dl_hwcap & HWCAP_S390_VX, WCSNCMP_Z13)
#  endif
#  if HAVE_WCSNCMP_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcschr,
#  if HAVE_WCSCHR_Z13
      IFUNC_IMPL_ADD (array, i, wcschr, dl_hwcap & HWCAP_S390_VX, WCSCHR_Z13)
#  endif
#  if HAVE_WCSCHR_C
...
#  if HAVE_WCSCHRNUL_Z13
	      IFUNC_IMPL_ADD (array, i, wcschrnul, dl_hwcap & HWCAP_S390_VX,
			      WCSCHRNUL_Z13)
#  endif
#  if HAVE_WCSCHRNUL_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcsrchr,
#  if HAVE_WCSRCHR_Z13
      IFUNC_IMPL_ADD (array, i, wcsrchr, dl_hwcap & HWCAP_S390_VX, WCSRCHR_Z13)
#  endif
#  if HAVE_WCSRCHR_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcsspn,
#  if HAVE_WCSSPN_Z13
      IFUNC_IMPL_ADD (array, i, wcsspn, dl_hwcap & HWCAP_S390_VX, WCSSPN_Z13)
#  endif
#  if HAVE_WCSSPN_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcspbrk,
#  if HAVE_WCSPBRK_Z13
      IFUNC_IMPL_ADD (array, i, wcspbrk, dl_hwcap & HWCAP_S390_VX, WCSPBRK_Z13)
#  endif
#  if HAVE_WCSPBRK_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wcscspn,
#  if HAVE_WCSCSPN_Z13
      IFUNC_IMPL_ADD (array, i, wcscspn, dl_hwcap & HWCAP_S390_VX, WCSCSPN_Z13)
#  endif
#  if HAVE_WCSCSPN_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wmemchr,
#  if HAVE_WMEMCHR_Z13
      IFUNC_IMPL_ADD (array, i, wmemchr, dl_hwcap & HWCAP_S390_VX, WMEMCHR_Z13)
#  endif
#  if HAVE_WMEMCHR_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wmemset,
#  if HAVE_WMEMSET_Z13
      IFUNC_IMPL_ADD (array, i, wmemset, dl_hwcap & HWCAP_S390_VX, WMEMSET_Z13)
#  endif
#  if HAVE_WMEMSET_C
...
#  endif
  ...
  IFUNC_IMPL (
      i, name, wmemcmp,
#  if HAVE_WMEMCMP_Z13
      IFUNC_IMPL_ADD (array, i, wmemcmp, dl_hwcap & HWCAP_S390_VX, WMEMCMP_Z13)
#  endif
#  if HAVE_WMEMCMP_C
