...
/* Activate all C11 atomic builtins.
   ...
   instructions on z196 zarch and higher cpus instead of a loop with
...
#define atomic_compare_and_exchange_val_acq(mem, newval, oldval)              \
  ({                                                                          \
    ...
    __atomic_compare_exchange_n (mem, (void *) &__atg1_oldval, newval, 1,     \
...
#define atomic_compare_and_exchange_val_rel(mem, newval, oldval)              \
  ({                                                                          \
    ...
    __atomic_compare_exchange_n (mem, (void *) &__atg1_2_oldval, newval, 1,   \
...
#define atomic_compare_and_exchange_bool_acq(mem, newval, oldval)             \
  ({                                                                          \
    ...
    !__atomic_compare_exchange_n (mem, (void *) &__atg2_oldval, newval, 1,    \
				  __ATOMIC_ACQUIRE, __ATOMIC_RELAXED);        \
  })
...
#define atomic_or(mem, mask)                                                  \
  ...
  while (0)
#define catomic_or(mem, mask) atomic_or (mem, mask)
...
#define atomic_and(mem, mask)                                                 \
  ...
  while (0)
#define catomic_and(mem, mask) atomic_and (mem, mask)
