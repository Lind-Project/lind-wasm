...
#define PPC_FEATURE_SMT                                                       \
  0x00004000 /* Simultaneous                                                  \
		Multi-Threading */
...
#define PPC_FEATURE2_HAS_HTM                                                  \
  0x40000000 /* Hardware Transactional                                        \
		Memory */
#define PPC_FEATURE2_HAS_DSCR                                                 \
  0x20000000				 /* Data Stream Control               \
					    Register */
#define PPC_FEATURE2_HAS_EBB 0x10000000	 /* Event Base Branching */
#define PPC_FEATURE2_HAS_ISEL 0x08000000 /* Integer Select */
#define PPC_FEATURE2_HAS_TAR 0x04000000	 /* Target Address Register */
#define PPC_FEATURE2_HAS_VEC_CRYPTO                                           \
  0x02000000 /* Target supports vector                                        \
		instruction.  */
#define PPC_FEATURE2_HTM_NOSC                                                 \
  0x01000000				  /* Kernel aborts transaction        \
					     when a syscall is made.  */
#define PPC_FEATURE2_ARCH_3_00 0x00800000 /* ISA 3.0 */
#define PPC_FEATURE2_HAS_IEEE128                                              \
  0x00400000			     /* VSX IEEE Binary Float                 \
					128-bit */
#define PPC_FEATURE2_DARN 0x00200000 /* darn instruction.  */
#define PPC_FEATURE2_SCV 0x00100000  /* scv syscall.  */
#define PPC_FEATURE2_HTM_NO_SUSPEND                                           \
  0x00080000				 /* TM without suspended              \
					    state.  */
