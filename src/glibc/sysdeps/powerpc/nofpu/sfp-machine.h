...
#  define _FP_DECL_EX                                                         \
    int _spefscr __attribute__ ((unused)),                                    \
	_ftrapex __attribute__ ((unused)) = 0
...
#  define FP_TRAPPING_EXCEPTIONS                                              \
    (_ftrapex & PR_FP_EXC_UND ? FP_EX_UNDERFLOW : 0)
...
libc_hidden_tls_proto (__sim_exceptions_thread, tls_model ("local-exec"));
...
libc_hidden_tls_proto (__sim_round_mode_thread, tls_model ("local-exec"));
