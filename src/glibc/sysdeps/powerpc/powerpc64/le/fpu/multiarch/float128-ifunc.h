...
/* MAKE_IEEE_IFUNC_R(func, pfx, r)
    Declare an ieee ifunc symbol used internally by libm.  E.g
   __ieee754_sinf128  */
#  define MAKE_IEEE_IFUNC_R(func, r)                                          \
    extern __typeof (__ieee754_##func##f128##r)                               \
	__ieee754_##func##f128_power8##r;                                     \
    extern __typeof (__ieee754_##func##f128##r)                               \
	__ieee754_##func##f128_power9##r;                                     \
...
#  define DECL_ALIAS_s_ldexp(f)                                               \
    MAKE_IFUNCP_R (f, ) MAKE_IFUNCP_WRAP_R (wrap_, scalbn, )

/* f64xfmaf128 is an alias of fmaf128.  */
#  define DECL_ALIAS_s_fma(f)                                                 \
    MAKE_IFUNCP_R (f, ) libm_alias_float128_narrow (__fma, fma)

/* f64xsqrtf128 is an alias of sqrtf128.  */
#  define DECL_ALIAS_w_sqrt(f)                                                \
    MAKE_IFUNCP_R (f, ) libm_alias_float128_narrow (__sqrt, sqrt)
