...
#  ifdef __LITTLE_ENDIAN__
	  ...
	  hwcap2 & PPC_FEATURE2_ARCH_3_1 && hwcap2 & PPC_FEATURE2_HAS_ISEL
	      && hwcap & PPC_FEATURE_HAS_VSX && cacheline_size == 128,
	  __memset_power10)
#  endif
	  IFUNC_IMPL_ADD (
	      array, i, memset,
	      hwcap2 & PPC_FEATURE2_ARCH_2_07
		  && hwcap & PPC_FEATURE_HAS_ALTIVEC && cacheline_size == 128,
	      __memset_power8) IFUNC_IMPL_ADD (array, i, memset,
					       hwcap & PPC_FEATURE_ARCH_2_06
						   && cacheline_size == 128,
					       __memset_power7)
...
#  endif
		  IFUNC_IMPL_ADD (array, i, strcpy,
		      ...
		      IFUNC_IMPL_ADD (array, i, strcpy,
					  ...
					  && hwcap & PPC_FEATURE_HAS_VSX,
				      __strcpy_power7)
			  IFUNC_IMPL_ADD (array, i, strcpy, 1, __strcpy_ppc))
...
#  endif
		  IFUNC_IMPL_ADD (array, i, stpcpy,
		      ...
		      IFUNC_IMPL_ADD (array, i, stpcpy,
					  ...
					  && hwcap & PPC_FEATURE_HAS_VSX,
				      __stpcpy_power7)
			  IFUNC_IMPL_ADD (array, i, stpcpy, 1, __stpcpy_ppc))
...
#  ifdef __LITTLE_ENDIAN__
	  ...
	  __strlen_power10) IFUNC_IMPL_ADD (array, i, strlen,
					    hwcap2 & PPC_FEATURE2_ARCH_3_00
						&& hwcap & PPC_FEATURE_HAS_VSX,
					    __strlen_power9)
#  endif
	  IFUNC_IMPL_ADD (array, i, strlen,
	      ...
	      IFUNC_IMPL_ADD (array, i, strlen, hwcap & PPC_FEATURE_ARCH_2_06,
			      __strlen_power7)
		  IFUNC_IMPL_ADD (array, i, strlen, 1, __strlen_ppc))
...
#  endif
		  IFUNC_IMPL_ADD (array, i, strncmp,
				  hwcap2 & PPC_FEATURE2_ARCH_2_07,
				  __strncmp_power8)
		      IFUNC_IMPL_ADD (array, i, strncmp, 1, __strncmp_ppc))
  ...
  IFUNC_IMPL (i, name, strchr,
		  ...
		  IFUNC_IMPL_ADD (array, i, strchr,
				  hwcap & PPC_FEATURE_ARCH_2_06,
				  __strchr_power7)
		      IFUNC_IMPL_ADD (array, i, strchr, 1, __strchr_ppc))
  ...
  IFUNC_IMPL (i, name, strchrnul,
		  ...
		  IFUNC_IMPL_ADD (array, i, strchrnul,
				  hwcap & PPC_FEATURE_ARCH_2_06,
				  __strchrnul_power7)
		      IFUNC_IMPL_ADD (array, i, strchrnul, 1, __strchrnul_ppc))
#endif
  ...
  IFUNC_IMPL (i, name, mempcpy,
	      IFUNC_IMPL_ADD (array, i, mempcpy,
				  ...
				  && hwcap & PPC_FEATURE_HAS_ALTIVEC,
			      __mempcpy_power7)
		  IFUNC_IMPL_ADD (array, i, mempcpy, 1, __mempcpy_ppc))
  ...
  IFUNC_IMPL (i, name, memchr,
		  ...
		  IFUNC_IMPL_ADD (array, i, memchr,
		      ...
		      IFUNC_IMPL_ADD (array, i, memchr,
				      hwcap & PPC_FEATURE_ARCH_2_06,
				      __memchr_power7)
			  IFUNC_IMPL_ADD (array, i, memchr, 1, __memchr_ppc))
  ...
  IFUNC_IMPL (i, name, memrchr,
		  ...
		  IFUNC_IMPL_ADD (array, i, memrchr,
				  hwcap & PPC_FEATURE_ARCH_2_06,
				  __memrchr_power7)
		      IFUNC_IMPL_ADD (array, i, memrchr, 1, __memrchr_ppc))
  ...
  IFUNC_IMPL (
	  ...
	  IFUNC_IMPL_ADD (array, i, rawmemchr,
	      ...
	      IFUNC_IMPL_ADD (array, i, rawmemchr,
			      hwcap & PPC_FEATURE_ARCH_2_06,
			      __rawmemchr_power7)
		  IFUNC_IMPL_ADD (array, i, rawmemchr, 1, __rawmemchr_ppc))
  ...
  IFUNC_IMPL (i, name, strnlen,
		  ...
		  IFUNC_IMPL_ADD (array, i, strnlen,
				  hwcap & PPC_FEATURE_ARCH_2_06,
				  __strnlen_power7)
		      IFUNC_IMPL_ADD (array, i, strnlen, 1, __strnlen_ppc))
  ...
  IFUNC_IMPL (
      ...
      IFUNC_IMPL_ADD (array, i, strcasecmp,
			  ...
			  && hwcap & PPC_FEATURE_HAS_ALTIVEC,
		      __strcasecmp_power8)
	  IFUNC_IMPL_ADD (array, i, strcasecmp, hwcap & PPC_FEATURE_ARCH_2_06,
			  __strcasecmp_power7)
  ...
  IFUNC_IMPL (
      i, name, strcasecmp_l,
      IFUNC_IMPL_ADD (array, i, strcasecmp_l, hwcap & PPC_FEATURE_ARCH_2_06,
		      __strcasecmp_l_power7)
	  IFUNC_IMPL_ADD (array, i, strcasecmp_l, 1, __strcasecmp_l_ppc))
  ...
  IFUNC_IMPL (
	  ...
	  IFUNC_IMPL_ADD (array, i, strncasecmp, hwcap & PPC_FEATURE_ARCH_2_06,
  ...
  IFUNC_IMPL (
      ...
      IFUNC_IMPL_ADD (array, i, strncasecmp_l, hwcap & PPC_FEATURE_ARCH_2_06,
		      __strncasecmp_l_power7)
	  IFUNC_IMPL_ADD (array, i, strncasecmp_l, 1, __strncasecmp_l_ppc))
  ...
  IFUNC_IMPL (i, name, strrchr,
		  ...
		  IFUNC_IMPL_ADD (array, i, strrchr,
				  hwcap & PPC_FEATURE_ARCH_2_06,
				  __strrchr_power7)
		      IFUNC_IMPL_ADD (array, i, strrchr, 1, __strrchr_ppc))
  ...
  IFUNC_IMPL (i, name, strncat,
		  ...
		  IFUNC_IMPL_ADD (array, i, strncat,
				  hwcap & PPC_FEATURE_ARCH_2_06
				      && hwcap & PPC_FEATURE_HAS_VSX,
				  __strncat_power7)
		      IFUNC_IMPL_ADD (array, i, strncat, 1, __strncat_ppc))
  ...
  IFUNC_IMPL (
      ...
      IFUNC_IMPL_ADD (array, i, strncpy,
		      ...
		      __strncpy_power9)
#endif
	  IFUNC_IMPL_ADD (array, i, strncpy, hwcap2 & PPC_FEATURE2_ARCH_2_07,
			  __strncpy_power8)
	      IFUNC_IMPL_ADD (array, i, strncpy, hwcap & PPC_FEATURE_ARCH_2_06,
			      __strncpy_power7)
		  IFUNC_IMPL_ADD (array, i, strncpy, 1, __strncpy_ppc))
  ...
  IFUNC_IMPL (
      ...
      IFUNC_IMPL_ADD (array, i, stpncpy,
		      ...
		      __stpncpy_power9)
#endif
	  IFUNC_IMPL_ADD (array, i, stpncpy, hwcap2 & PPC_FEATURE2_ARCH_2_07,
			  __stpncpy_power8)
	      IFUNC_IMPL_ADD (array, i, stpncpy, hwcap & PPC_FEATURE_ARCH_2_06,
			      __stpncpy_power7)
		  IFUNC_IMPL_ADD (array, i, stpncpy, 1, __stpncpy_ppc))
...
#endif
	      IFUNC_IMPL_ADD (array, i, strcmp,
			      hwcap2 & PPC_FEATURE2_ARCH_2_07, __strcmp_power8)
		  IFUNC_IMPL_ADD (array, i, strcmp,
				  hwcap & PPC_FEATURE_ARCH_2_06,
				  __strcmp_power7)
		      IFUNC_IMPL_ADD (array, i, strcmp, 1, __strcmp_ppc))
  ...
  IFUNC_IMPL (i, name, strcat,
		  ...
		  IFUNC_IMPL_ADD (array, i, strcat,
				  hwcap & PPC_FEATURE_ARCH_2_06
				      && hwcap & PPC_FEATURE_HAS_VSX,
				  __strcat_power7)
		      IFUNC_IMPL_ADD (array, i, strcat, 1, __strcat_ppc))
  ...
  IFUNC_IMPL (i, name, strspn,
	      IFUNC_IMPL_ADD (array, i, strspn,
				  ...
				  && hwcap & PPC_FEATURE_HAS_VSX,
			      __strspn_power8)
		  IFUNC_IMPL_ADD (array, i, strspn, 1, __strspn_ppc))
  ...
  IFUNC_IMPL (i, name, strcspn,
	      IFUNC_IMPL_ADD (array, i, strcspn,
				  ...
				  && hwcap & PPC_FEATURE_HAS_VSX,
			      __strcspn_power8)
		  IFUNC_IMPL_ADD (array, i, strcspn, 1, __strcspn_ppc))
