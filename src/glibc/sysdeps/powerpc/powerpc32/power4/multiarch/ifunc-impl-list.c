			...
			size_t max)
{
  ...
  IFUNC_IMPL (
      ...
      IFUNC_IMPL_ADD (array, i, strncasecmp_l, hwcap & PPC_FEATURE_HAS_VSX,
  ...
  IFUNC_IMPL (i, name, strchrnul,
	      IFUNC_IMPL_ADD (array, i, strchrnul, hwcap & PPC_FEATURE_HAS_VSX,
			      __strchrnul_power7)
		  IFUNC_IMPL_ADD (array, i, strchrnul, 1, __strchrnul_ppc))

  /* Support sysdeps/powerpc/powerpc32/power4/multiarch/strchr.c.  */
  IFUNC_IMPL (i, name, strchr,
	      IFUNC_IMPL_ADD (array, i, strchr, hwcap & PPC_FEATURE_HAS_VSX,
			      __strchr_power7)
