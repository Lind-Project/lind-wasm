			...
			size_t max)
{
  ...
  IFUNC_IMPL (i, name, __memcmpeq,
		 ...
		 implementation is also used at ISA level 2.  */
	      X86_IFUNC_IMPL_ADD_V2 (array, i, __memcmpeq, 1, __memcmpeq_sse2))
  ...
  IFUNC_IMPL (
      ...
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, memchr, 1, __memchr_sse2))
  ...
  IFUNC_IMPL (
	 ...
	 sysdeps/x86_64/memcmp-isa-default-impl.h.  */
	  ...
	  X86_IFUNC_IMPL_ADD_V3 (array, i, memcmp,
		  ...
		  array, i, memcmp,
		  (CPU_FEATURE_USABLE (AVX2) && CPU_FEATURE_USABLE (BMI2)
		   && CPU_FEATURE_USABLE (MOVBE) && CPU_FEATURE_USABLE (RTM)),
		  __memcmp_avx2_movbe_rtm)
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, memcmp, 1, __memcmp_sse2))

#ifdef SHARED
  /* Support sysdeps/x86_64/multiarch/memmove_chk.c.  */
  IFUNC_IMPL (
      i, name, __memmove_chk,
      IFUNC_IMPL_ADD (array, i, __memmove_chk, 1, __memmove_chk_erms)
      ...
      X86_IFUNC_IMPL_ADD_V2 (array, i, __memmove_chk,
			     CPU_FEATURE_USABLE (SSSE3), __memmove_chk_ssse3)
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
  ...
  IFUNC_IMPL (
      ...
      /* By V3 we assume fast aligned copy.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, memmove, CPU_FEATURE_USABLE (SSSE3),
			     __memmove_ssse3)
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2 (SSSE3 is too
	 optimized around aligned copy to be better as general
	 purpose memmove).  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, memmove, 1, __memmove_sse2_unaligned)
  ...
  IFUNC_IMPL (
	  ...
	  array, i, memrchr,
	  (CPU_FEATURE_USABLE (AVX512VL) && CPU_FEATURE_USABLE (AVX512BW)
	   && CPU_FEATURE_USABLE (BMI2) && CPU_FEATURE_USABLE (LZCNT)),
	  __memrchr_evex)
	  X86_IFUNC_IMPL_ADD_V3 (array, i, memrchr,
		  ...
		  array, i, memrchr,
		  (CPU_FEATURE_USABLE (AVX2) && CPU_FEATURE_USABLE (BMI2)
		   && CPU_FEATURE_USABLE (LZCNT) && CPU_FEATURE_USABLE (RTM)),
		  __memrchr_avx2_rtm)
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, memrchr, 1, __memrchr_sse2))

#ifdef SHARED
  /* Support sysdeps/x86_64/multiarch/memset_chk.c.  */
  IFUNC_IMPL (
      i, name, __memset_chk,
      IFUNC_IMPL_ADD (array, i, __memset_chk, 1, __memset_chk_erms)
  ...
  IFUNC_IMPL (
      ...
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, rawmemchr, 1, __rawmemchr_sse2))
  ...
  IFUNC_IMPL (i, name, strlen,
	      ...
	      /* ISA V2 wrapper for SSE2 implementation because the SSE2
		 implementation is also used at ISA level 2.  */
	      X86_IFUNC_IMPL_ADD_V2 (array, i, strlen, 1, __strlen_sse2))
  ...
  IFUNC_IMPL (i, name, strnlen,
	      ...
	      /* ISA V2 wrapper for SSE2 implementation because the SSE2
		 implementation is also used at ISA level 2.  */
	      X86_IFUNC_IMPL_ADD_V2 (array, i, strnlen, 1, __strnlen_sse2))
  ...
  IFUNC_IMPL (
	  ...
	  (CPU_FEATURE_USABLE (AVX512VL) && CPU_FEATURE_USABLE (AVX512BW)),
	  __stpncpy_evex)
	  X86_IFUNC_IMPL_ADD_V3 (array, i, stpncpy, CPU_FEATURE_USABLE (AVX2),
				 __stpncpy_avx2)
	      X86_IFUNC_IMPL_ADD_V3 (
		  array, i, stpncpy,
	 ...
	 level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, stpncpy, 1, __stpncpy_sse2_unaligned))
  ...
  IFUNC_IMPL (
	  ...
	  (CPU_FEATURE_USABLE (AVX512VL) && CPU_FEATURE_USABLE (AVX512BW)),
	  __stpcpy_evex)
	  X86_IFUNC_IMPL_ADD_V3 (array, i, stpcpy, CPU_FEATURE_USABLE (AVX2),
				 __stpcpy_avx2)
	      X86_IFUNC_IMPL_ADD_V3 (
		  array, i, stpcpy,
		  (CPU_FEATURE_USABLE (AVX2) && CPU_FEATURE_USABLE (RTM)),
	 ...
	 the sse2_unaligned implementation is also used at ISA
	 level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, stpcpy, 1, __stpcpy_sse2_unaligned)
	  X86_IFUNC_IMPL_ADD_V1 (array, i, stpcpy, 1, __stpcpy_sse2))
  ...
  IFUNC_IMPL (
      ...
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, strcasecmp, 1, __strcasecmp_sse2))
  ...
  IFUNC_IMPL (
      ...
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, strcasecmp_l, 1, __strcasecmp_l_sse2))
  ...
  IFUNC_IMPL (
	  ...
	  (CPU_FEATURE_USABLE (AVX512VL) && CPU_FEATURE_USABLE (AVX512BW)),
	  __strcat_evex)
	  X86_IFUNC_IMPL_ADD_V3 (array, i, strcat, CPU_FEATURE_USABLE (AVX2),
				 __strcat_avx2)
	      X86_IFUNC_IMPL_ADD_V3 (
		  array, i, strcat,
		  (CPU_FEATURE_USABLE (AVX2) && CPU_FEATURE_USABLE (RTM)),
	 ...
	 the sse2_unaligned implementation is also used at ISA
	 level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, strcat, 1, __strcat_sse2_unaligned)
	  X86_IFUNC_IMPL_ADD_V1 (array, i, strcat, 1, __strcat_sse2))
  ...
  IFUNC_IMPL (
      ...
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, strchr, 1, __strchr_sse2)
	  X86_IFUNC_IMPL_ADD_V1 (array, i, strchr, 1, __strchr_sse2_no_bsf))
  ...
  IFUNC_IMPL (i, name, strchrnul,
	      ...
	      /* ISA V2 wrapper for SSE2 implementation because the SSE2
		 implementation is also used at ISA level 2.  */
	      X86_IFUNC_IMPL_ADD_V2 (array, i, strchrnul, 1, __strchrnul_sse2))
  ...
  IFUNC_IMPL (
	  ...
	  array, i, strrchr,
	  (CPU_FEATURE_USABLE (AVX512VL) && CPU_FEATURE_USABLE (AVX512BW)
	   && CPU_FEATURE_USABLE (BMI1) && CPU_FEATURE_USABLE (BMI2)),
	  __strrchr_evex)
      ...
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, strrchr, 1, __strrchr_sse2))
  ...
  IFUNC_IMPL (
	  ...
	  (CPU_FEATURE_USABLE (AVX512VL) && CPU_FEATURE_USABLE (AVX512BW)
	   && CPU_FEATURE_USABLE (BMI2)),
	  __strcmp_evex) X86_IFUNC_IMPL_ADD_V3 (array, i, strcmp,
						(CPU_FEATURE_USABLE (AVX2)
						 && CPU_FEATURE_USABLE (BMI2)),
						__strcmp_avx2)
	 ...
	 implementations are also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, strcmp, 1, __strcmp_sse2_unaligned)
	  X86_IFUNC_IMPL_ADD_V2 (array, i, strcmp, 1, __strcmp_sse2))
  ...
  IFUNC_IMPL (
	  ...
	  (CPU_FEATURE_USABLE (AVX512VL) && CPU_FEATURE_USABLE (AVX512BW)),
	  __strcpy_evex)
	  X86_IFUNC_IMPL_ADD_V3 (array, i, strcpy, CPU_FEATURE_USABLE (AVX2),
				 __strcpy_avx2)
	      X86_IFUNC_IMPL_ADD_V3 (
		  array, i, strcpy,
		  (CPU_FEATURE_USABLE (AVX2) && CPU_FEATURE_USABLE (RTM)),
	 ...
	 the sse2_unaligned implementation is also used at ISA
	 level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, strcpy, 1, __strcpy_sse2_unaligned)
	  X86_IFUNC_IMPL_ADD_V1 (array, i, strcpy, 1, __strcpy_sse2))
  ...
  IFUNC_IMPL (
      ...
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, strncasecmp, 1, __strncasecmp_sse2))

  /* Support sysdeps/x86_64/multiarch/strncase_l.c.  */
  IFUNC_IMPL (
      i, name, strncasecmp_l,
      X86_IFUNC_IMPL_ADD_V4 (
	  array, i, strncasecmp,
	  (CPU_FEATURE_USABLE (AVX512VL) & CPU_FEATURE_USABLE (AVX512BW)
	   && CPU_FEATURE_USABLE (BMI2)),
      ...
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, strncasecmp_l, 1, __strncasecmp_l_sse2))
  ...
  IFUNC_IMPL (
	  ...
	  (CPU_FEATURE_USABLE (AVX512VL) && CPU_FEATURE_USABLE (AVX512BW)),
	  __strncat_evex)
	  X86_IFUNC_IMPL_ADD_V3 (array, i, strncat, CPU_FEATURE_USABLE (AVX2),
				 __strncat_avx2)
	      X86_IFUNC_IMPL_ADD_V3 (
		  array, i, strncat,
		  (CPU_FEATURE_USABLE (AVX2) && CPU_FEATURE_USABLE (RTM)),
	 ...
	 the sse2_unaligned implementation is also used at ISA
	 level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, strncat, 1, __strncat_sse2_unaligned))
  ...
  IFUNC_IMPL (
	  ...
	  (CPU_FEATURE_USABLE (AVX512VL) && CPU_FEATURE_USABLE (AVX512BW)),
	  __strncpy_evex)
	  X86_IFUNC_IMPL_ADD_V3 (array, i, strncpy, CPU_FEATURE_USABLE (AVX2),
				 __strncpy_avx2)
	      X86_IFUNC_IMPL_ADD_V3 (
		  array, i, strncpy,
		  (CPU_FEATURE_USABLE (AVX2) && CPU_FEATURE_USABLE (RTM)),
	 ...
	 the sse2_unaligned implementation is also used at ISA
	 level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, strncpy, 1, __strncpy_sse2_unaligned))
  ...
  IFUNC_IMPL (i, name, wcschr,
	      ...
	      /* ISA V2 wrapper for SSE2 implementation because the SSE2
		 implementation is also used at ISA level 2.  */
	      X86_IFUNC_IMPL_ADD_V2 (array, i, wcschr, 1, __wcschr_sse2))
  ...
  IFUNC_IMPL (
      ...
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, wcsrchr, 1, __wcsrchr_sse2))
  ...
  IFUNC_IMPL (
	  ...
	  (CPU_FEATURE_USABLE (AVX512VL) && CPU_FEATURE_USABLE (AVX512BW)
	   && CPU_FEATURE_USABLE (BMI2)),
	  __wcscpy_evex) X86_IFUNC_IMPL_ADD_V3 (array, i, wcscpy,
						(CPU_FEATURE_USABLE (AVX2)
						 && CPU_FEATURE_USABLE (BMI2)),
						__wcscpy_avx2)
	  X86_IFUNC_IMPL_ADD_V2 (array, i, wcscpy, CPU_FEATURE_USABLE (SSSE3),
				 __wcscpy_ssse3)
	      X86_IFUNC_IMPL_ADD_V1 (array, i, wcscpy, 1, __wcscpy_generic))
  ...
  IFUNC_IMPL (
	  ...
	  X86_IFUNC_IMPL_ADD_V3 (
	      ...
	      (CPU_FEATURE_USABLE (AVX2) && CPU_FEATURE_USABLE (BMI2)),
	      __wcsncpy_avx2)
	      X86_IFUNC_IMPL_ADD_V2 (array, i, wcpncpy, 1, __wcsncpy_generic))
  ...
  IFUNC_IMPL (
	  ...
	  (CPU_FEATURE_USABLE (AVX512VL) && CPU_FEATURE_USABLE (AVX512BW)
	   && CPU_FEATURE_USABLE (BMI2)),
	  __wcpcpy_evex) X86_IFUNC_IMPL_ADD_V3 (array, i, wcpcpy,
						(CPU_FEATURE_USABLE (AVX2)
						 && CPU_FEATURE_USABLE (BMI2)),
						__wcpcpy_avx2)
	  X86_IFUNC_IMPL_ADD_V2 (array, i, wcpcpy, 1, __wcpcpy_generic))
  ...
  IFUNC_IMPL (
	  ...
	  X86_IFUNC_IMPL_ADD_V3 (
	      ...
	      (CPU_FEATURE_USABLE (AVX2) && CPU_FEATURE_USABLE (BMI2)),
	      __wcpncpy_avx2)
	      X86_IFUNC_IMPL_ADD_V2 (array, i, wcsncpy, 1, __wcpncpy_generic))
  ...
  IFUNC_IMPL (
	  ...
	  (CPU_FEATURE_USABLE (AVX512VL) && CPU_FEATURE_USABLE (AVX512BW)
	   && CPU_FEATURE_USABLE (BMI2)),
	  __wcscat_evex) X86_IFUNC_IMPL_ADD_V3 (array, i, wcscat,
						(CPU_FEATURE_USABLE (AVX2)
						 && CPU_FEATURE_USABLE (BMI2)),
						__wcscat_avx2)
	  X86_IFUNC_IMPL_ADD_V2 (array, i, wcscat, 1, __wcscat_generic))
  ...
  IFUNC_IMPL (
	  ...
	  X86_IFUNC_IMPL_ADD_V3 (
	      ...
	      (CPU_FEATURE_USABLE (AVX2) && CPU_FEATURE_USABLE (BMI2)),
	      __wcsncat_avx2)
	      X86_IFUNC_IMPL_ADD_V2 (array, i, wcsncat, 1, __wcsncat_generic))
		  ...
		  X86_IFUNC_IMPL_ADD_V4 (array, i, wcslen,
			  ...
			  X86_IFUNC_IMPL_ADD_V3 (array, i, wcslen,
						 (CPU_FEATURE_USABLE (AVX2)
						  ...
						  && CPU_FEATURE_USABLE (RTM)),
						 __wcslen_avx2_rtm)
			      X86_IFUNC_IMPL_ADD_V2 (
				  array, i, wcslen,
				  CPU_FEATURE_USABLE (SSE4_1), __wcslen_sse4_1)
				  X86_IFUNC_IMPL_ADD_V1 (array, i, wcslen, 1,
							 __wcslen_sse2))
	  ...
	  X86_IFUNC_IMPL_ADD_V4 (array, i, wcsnlen,
		  ...
		  X86_IFUNC_IMPL_ADD_V3 (array, i, wcsnlen,
		      ...
		      X86_IFUNC_IMPL_ADD_V2 (array, i, wcsnlen,
					     ...
					     __wcsnlen_sse4_1)
			  X86_IFUNC_IMPL_ADD_V1 (array, i, wcsnlen, 1,
						 __wcsnlen_generic))
  ...
  IFUNC_IMPL (
      ...
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, wmemchr, 1, __wmemchr_sse2))
  ...
  IFUNC_IMPL (
      ...
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, wmemcmp, 1, __wmemcmp_sse2))
  ...
  IFUNC_IMPL (
      ...
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, wmemset, 1, __wmemset_sse2_unaligned))

#ifdef SHARED
  /* Support sysdeps/x86_64/multiarch/memcpy_chk.c.  */
  IFUNC_IMPL (
      i, name, __memcpy_chk,
      IFUNC_IMPL_ADD (array, i, __memcpy_chk, 1, __memcpy_chk_erms)
      ...
      X86_IFUNC_IMPL_ADD_V2 (array, i, __memcpy_chk,
			     CPU_FEATURE_USABLE (SSSE3), __memcpy_chk_ssse3)
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2 (SSSE3 is too
	 optimized around aligned copy to be better as general
	 purpose memmove).  */
  ...
  IFUNC_IMPL (
      ...
      /* By V3 we assume fast aligned copy.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, memcpy, CPU_FEATURE_USABLE (SSSE3),
			     __memcpy_ssse3)
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2 (SSSE3 is too
	 optimized around aligned copy to be better as general
	 purpose memmove).  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, memcpy, 1, __memcpy_sse2_unaligned)
  ...
  IFUNC_IMPL (
      ...
      IFUNC_IMPL_ADD (array, i, __mempcpy_chk, 1, __mempcpy_chk_erms)
      ...
      X86_IFUNC_IMPL_ADD_V2 (array, i, __mempcpy_chk,
			     CPU_FEATURE_USABLE (SSSE3), __mempcpy_chk_ssse3)
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2 (SSSE3 is too
	 optimized around aligned copy to be better as general
	 purpose memmove).  */
  ...
  IFUNC_IMPL (
      ...
      /* By V3 we assume fast aligned copy.  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, mempcpy, CPU_FEATURE_USABLE (SSSE3),
			     __mempcpy_ssse3)
      /* ISA V2 wrapper for SSE2 implementation because the SSE2
	 implementation is also used at ISA level 2 (SSSE3 is too
	 optimized around aligned copy to be better as general
	 purpose memmove).  */
      X86_IFUNC_IMPL_ADD_V2 (array, i, mempcpy, 1, __mempcpy_sse2_unaligned)
  ...
  IFUNC_IMPL (i, name, strncmp,
	      ...
	      /* ISA V2 wrapper for SSE2 implementation because the SSE2
		 implementation is also used at ISA level 2.  */
	      X86_IFUNC_IMPL_ADD_V2 (array, i, strncmp, 1, __strncmp_sse2))
