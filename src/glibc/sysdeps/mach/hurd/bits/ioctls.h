...
#    error                                                                     \
	"Never use <bits/ioctls.h> directly; include <hurd/ioctl.h> instead."
#  endif
...
#  define SIOCSIFFLAGS _IOW ('i', 16, struct ifreq_short) /* set ifnet flags  \
							   */
#  define SIOCGIFFLAGS                                                        \
    _IOWR ('i', 17, struct ifreq_short) /* get ifnet flags */
#  define OSIOCGIFBRDADDR                                                     \
    _IOWR ('i', 18, struct ifreq)		       /* get broadcast addr */
...
#    define TIOCSETP _IOW ('t', 9, struct sgttyb) /* set parameters -- stty   \
						   */
#    define TIOCSETN                                                          \
      _IOW ('t', 10, struct sgttyb) /* as above, but no flushtty*/
...
#    define TIOCSLTC                                                          \
      _IOW ('t', 117, struct ltchars) /* set local special chars*/
#    define TIOCGLTC                                                          \
