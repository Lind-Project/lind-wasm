...
#    define STATE_SAVE_MASK                                                   \
      ((1 << X86_XSTATE_SSE_ID) | (1 << X86_XSTATE_AVX_ID)                    \
       | (1 << X86_XSTATE_BNDREGS_ID) | (1 << X86_XSTATE_K_ID)                \
       | (1 << X86_XSTATE_ZMM_H_ID) | (1 << X86_XSTATE_ZMM_ID)                \
...
#    define FULL_STATE_SAVE_MASK (STATE_SAVE_MASK | AMX_STATE_SAVE_MASK)
#  else
