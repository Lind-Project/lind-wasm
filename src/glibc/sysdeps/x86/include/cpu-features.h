...
#  define CPU_FEATURE_CHECK_P(ptr, name, check)                               \
    ((ptr->features[index_cpu_##name].check.reg_##name & bit_cpu_##name) != 0)
...
#  define CPU_FEATURE_CPU_P(ptr, name) CPU_FEATURE_PRESENT_P (ptr, name)
#  define CPU_FEATURE_USABLE_P(ptr, name) CPU_FEATURE_ACTIVE_P (ptr, name)

/* HAS_CPU_FEATURE evaluates to true if CPU supports the feature.  */
#  define HAS_CPU_FEATURE(name) CPU_FEATURE_CPU_P (__get_cpu_features (), name)
...
#  define CPU_FEATURES_CPU_P(ptr, name) CPU_FEATURE_CPU_P (ptr, name)
#  define CPU_FEATURES_ARCH_P(ptr, name) CPU_FEATURE_PREFERRED_P (ptr, name)
#  define HAS_ARCH_FEATURE(name) CPU_FEATURE_PREFERRED (name)
...
extern void _dl_cet_setup_features (unsigned int) attribute_hidden;
#  endif

#  ifdef __x86_64__
#    define HAS_CPUID 1
#  elif (defined __i586__ || defined __pentium__ || defined __geode__         \
	 || defined __k6__)
#    define HAS_CPUID 1
#    define HAS_I586 1
