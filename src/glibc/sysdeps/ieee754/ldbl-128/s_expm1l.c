...
static const _Float128 P0 = L (2.943520915569954073888921213330863757240E8),
...
__expm1l (_Float128 x)
{
  ...
  px = (((((((P7 * x + P6) * x + P5) * x + P4) * x + P3) * x + P2) * x + P1)
	    * x
	+ P0)
       * x;
...
libm_hidden_def (__expm1l) libm_alias_ldouble (__expm1, expm1)
