 ...
 */
static const _Float128 R5 = L (-8.828896441624934385266096344596648080902E-1),
...
__log1pl (_Float128 xm1)
{
  ...
  z = x * x;
  r = (((((((((((P12 * x + P11) * x + P10) * x + P9) * x + P8) * x + P7) * x
	    + P6)
	       * x
	   + P5)
	      * x
	...
	+ P2)
	  ...
	  * x
      + P0;
  s = (((((((((((x + Q11) * x + Q10) * x + Q9) * x + Q8) * x + Q7) * x + Q6)
	       * x
	   + Q5)
	      * x
	  + Q4)
