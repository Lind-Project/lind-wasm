...
union ieee854_float128
{
  ...
  struct
  {
    __FLT_EORDER6 (unsigned int, negative : 1, exponent : 15, mantissa0 : 16,
		   mantissa1 : 32, mantissa2 : 32, mantissa3 : 32)
  } ieee;

  /* This format makes it easier to see if a NaN is a signalling NaN.  */
  struct
  {
    __FLT_EORDER7 (unsigned int, negative : 1, exponent : 15, quiet_nan : 1,
		   mantissa0 : 15, mantissa1 : 32, mantissa2 : 32,
		   mantissa3 : 32)
  } ieee_nan;
};
