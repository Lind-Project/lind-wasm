...
static const long double lgamma_coeff[] = {
  ...
  0x2.dfd2c703c0cfff44p-4L,  -0x1.6476701181f39edcp+0L,
  0xd.672219167002d3ap+0L,   -0x9.cd9292e6660d55bp+4L,
  0x8.911a740da740da7p+8L,   -0x8.d0cc570e255bf5ap+12L,
  0xa.8d1044d3708d1c2p+16L,  -0xe.8844d8a169abbc4p+20L,
};
...
static const size_t poly_deg[] = {
  13, 13, 14, 15, 16, 15, 14, 13,
};

static const size_t poly_end[] = {
  13, 27, 42, 58, 75, 91, 106, 120,
};
