...
static const long double tiny = 1.0e-300L, zero = 0.0,
			 pi_o_4
...
__ieee754_atan2l (long double y, long double x)
{
  ...
  if (((ix) > 0x7ff0000000000000LL)
    ...
    return x + y;
  if (((hx - 0x3ff0000000000000LL)) == 0 && (lx & 0x7fffffffffffffff) == 0)
      ...
      if (iy == 0x7ff0000000000000LL)
	{
	  switch (m)
	    ...
	    case 1:
	      return -pi_o_4 - tiny; /* atan(-INF,+INF) */
	    case 2:
	      return 3.0L * pi_o_4 + tiny; /*atan(+INF,-INF)*/
	    case 3:
	      return -3.0L * pi_o_4 - tiny; /*atan(-INF,-INF)*/
	    }
	}
