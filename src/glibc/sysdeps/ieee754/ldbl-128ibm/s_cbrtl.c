...
static const long double CBRT2I
    = 0.7937005259840997373758528196361541301957467L;
static const long double CBRT4I
...
__cbrtl (long double x)
{
  ...
  x = ((((1.3584464340920900529734e-1L * x - 6.3986917220457538402318e-1L) * x
	 + 1.2875551670318751538055e0L)
	    * x
	- 1.4897083391357284957891e0L)
	   * x
       + 1.3304961236013647092521e0L)
	  * x
