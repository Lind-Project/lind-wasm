...
VPCS_VECTOR_WRAPPER_ff (atan2f_advsimd, _ZGVnN4vv_atan2f)
    VPCS_VECTOR_WRAPPER (cosf_advsimd, _ZGVnN4v_cosf) VPCS_VECTOR_WRAPPER (
	expf_advsimd, _ZGVnN4v_expf) VPCS_VECTOR_WRAPPER (exp10f_advsimd,
							  _ZGVnN4v_exp10f)
	VPCS_VECTOR_WRAPPER (exp2f_advsimd, _ZGVnN4v_exp2f)
		...
		VPCS_VECTOR_WRAPPER (logf_advsimd, _ZGVnN4v_logf)
			...
			VPCS_VECTOR_WRAPPER (log1pf_advsimd, _ZGVnN4v_log1pf)
				...
				VPCS_VECTOR_WRAPPER (sinf_advsimd,
						     _ZGVnN4v_sinf)
				    VPCS_VECTOR_WRAPPER (tanf_advsimd,
							 _ZGVnN4v_tanf)
