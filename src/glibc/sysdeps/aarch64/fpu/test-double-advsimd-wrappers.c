...
VPCS_VECTOR_WRAPPER_ff (atan2_advsimd, _ZGVnN2vv_atan2) VPCS_VECTOR_WRAPPER (
    cos_advsimd, _ZGVnN2v_cos) VPCS_VECTOR_WRAPPER (exp_advsimd, _ZGVnN2v_exp)
		...
		VPCS_VECTOR_WRAPPER (log_advsimd, _ZGVnN2v_log)
			...
			VPCS_VECTOR_WRAPPER (log1p_advsimd, _ZGVnN2v_log1p)
				...
				VPCS_VECTOR_WRAPPER (sin_advsimd, _ZGVnN2v_sin)
				    VPCS_VECTOR_WRAPPER (tan_advsimd,
							 _ZGVnN2v_tan)
