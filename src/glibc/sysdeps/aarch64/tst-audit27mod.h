...
float tst_audit27_func_float (float a0, float a1, float a2, float a3, float a4,
...
double tst_audit27_func_double (double a0, double a1, double a2, double a3,
...
long double tst_audit27_func_ldouble (long double a0, long double a1,
				      long double a2, long double a3,
				      long double a4, long double a5,
