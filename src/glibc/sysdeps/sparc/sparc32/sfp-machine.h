...
#define __FP_FRAC_ADD_3(r2, r1, r0, x2, x1, x0, y2, y1, y0)                   \
  __asm__ (                                                                   \
      "addcc %r7,%8,%2\n\
	    addxcc %r5,%6,%1\n\
	    addx %r3,%4,%0"                                                     \
      : "=r"((USItype) (r2)), "=&r"((USItype) (r1)), "=&r"((USItype) (r0))    \
      : "%rJ"((USItype) (x2)), "rI"((USItype) (y2)), "%rJ"((USItype) (x1)),   \
	"rI"((USItype) (y1)), "%rJ"((USItype) (x0)), "rI"((USItype) (y0))     \
      : "cc")
    ...
    {                                                                         \
	 ...
	 input/outputs.  */                                                   \
      ...
      __asm__ __volatile__ ("\
	    ...
	    addxcc %r4,%5,%%g2\n\
	    addx %r2,%3,%%g1"                                                \
			    : "=&r"((USItype) (r1)), "=&r"((USItype) (r0))    \
			    : "%rJ"((USItype) (x3)), "rI"((USItype) (y3)),    \
			      "%rJ"((USItype) (x2)), "rI"((USItype) (y2)),    \
			      "%rJ"((USItype) (x1)), "rI"((USItype) (y1)),    \
			      "%rJ"((USItype) (x0)), "rI"((USItype) (y0))     \
			    : "cc", "g1", "g2");                              \
...
#define __FP_FRAC_ADDI_4(x3, x2, x1, x0, i)                                   \
  __asm__ ("addcc %3,%4,%3\n\
	    ...
	    addxcc %1,%%g0,%1\n\
	    addx %0,%%g0,%0"                                                 \
	   : "=&r"((USItype) (x3)), "=&r"((USItype) (x2)),                    \
	     "=&r"((USItype) (x1)), "=&r"((USItype) (x0))                     \
	   : "rI"((USItype) (i)), "0"((USItype) (x3)), "1"((USItype) (x2)),   \
	     "2"((USItype) (x1)), "3"((USItype) (x0))                         \
	   : "cc")
