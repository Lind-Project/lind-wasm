...
#  define SPARC_PIC_THUNK(reg)                                                \
    ...
    .section.text.__sparc_get_pc_thunk.reg, "axG", @progbits,                 \
	__sparc_get_pc_thunk.reg, comdat;                                     \
    .align 32;                                                                \
    .weak __sparc_get_pc_thunk.reg;                                           \
    .hidden __sparc_get_pc_thunk.reg;                                         \
    .type __sparc_get_pc_thunk.reg, #function;                                \
    __sparc_get_pc_thunk.reg : jmp % o7 + 8;                                  \
    add % o7, % reg, % ##reg;                                                 \
    .previous;                                                                \
    .endif;
...
#  define END_NOCFI(name) .size name, .- name
