...
#  ifndef FE_DOWNWARD
#    define FE_DOWNWARD                                                       \
      FE_CONSTRUCT_DISTINCT_VALUE (ORIG_FE_TONEAREST, ORIG_FE_TOWARDZERO,     \
				   ORIG_FE_UPWARD)
#  endif
#  ifndef FE_TONEAREST
#    define FE_TONEAREST                                                      \
      FE_CONSTRUCT_DISTINCT_VALUE (FE_DOWNWARD, ORIG_FE_TOWARDZERO,           \
				   ORIG_FE_UPWARD)
#  endif
#  ifndef FE_TOWARDZERO
#    define FE_TOWARDZERO                                                     \
      FE_CONSTRUCT_DISTINCT_VALUE (FE_DOWNWARD, FE_TONEAREST, ORIG_FE_UPWARD)
#  endif
#  ifndef FE_UPWARD
#    define FE_UPWARD                                                         \
      FE_CONSTRUCT_DISTINCT_VALUE (FE_DOWNWARD, FE_TONEAREST, FE_TOWARDZERO)
#  endif
...
{
#  if (defined _FPU_RC_DOWN || defined _FPU_RC_NEAREST                        \
       || defined _FPU_RC_ZERO || defined _FPU_RC_UP)
  fpu_control_t fc;
