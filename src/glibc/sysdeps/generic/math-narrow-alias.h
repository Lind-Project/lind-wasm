...
#  define libm_alias_float_double_main(func)                                  \
    weak_alias (__f##func, f##func) weak_alias (__f##func, f32##func##f64)    \
	weak_alias (__f##func, f32##func##f32x)

#  ifdef NO_LONG_DOUBLE
#    define libm_alias_float_double(func)                                     \
      libm_alias_float_double_main (func) weak_alias (__f##func, f##func##l)
#  else
#    define libm_alias_float_double(func) libm_alias_float_double_main (func)
#  endif
...
#    define libm_alias_double_narrow(from, to)                                \
      libm_alias_double_narrow_main (from, to) weak_alias (from, d##to##l)
#  else
#    define libm_alias_double_narrow(from, to)                                \
      libm_alias_double_narrow_main (from, to)
#  endif

#  if __HAVE_FLOAT64X_LONG_DOUBLE && __HAVE_FLOAT128                          \
...
#  if __HAVE_DISTINCT_FLOAT128 && __HAVE_FLOAT64X                             \
