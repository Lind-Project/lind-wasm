...
#define __m81_defun(rettype, func, args, attrs)                               \
  __m81_inline rettype attrs __m81_nth (__m81_u (func) args)
...
__inline_mathop (__atan, atan, ) __inline_mathop (__cos, cos, ) __inline_mathop (
    __sin,
    sin, ) __inline_mathop (__tan,
			    tan, ) __inline_mathop (__tanh,
						    tanh, ) __inline_mathop (__fabs,
									     abs,
									     __attribute__ ((
										 __const__)))

    __inline_mathop (__rint, int, ) __inline_mathop (
	__expm1, etoxm1, ) __inline_mathop (__log1p, lognp1, )
...
#define __CONCAT_l(arg) arg##l
		__inline_functions (double, __CONCAT_d) __inline_functions (
		    float, __CONCAT_f) __inline_functions (long double,
							   __CONCAT_l)
...
#define __inline_functions(float_type, m)                                     \
  ...
  {                                                                           \
    ...
    return (__fpsr & (3 << 24)) == 0;                                         \
                                                                              ...
                                                                              \
  __m81_defun (float_type, m (__scalbn), (float_type __x, int __n), )         \
  {                                                                           \
    float_type __result;                                                      \
    __asm __volatile__ ("fscale%.l %1, %0"                                    \
			: "=f"(__result)                                      \
			: "dmi"(__n), "0"(__x));                              \
    return __result;                                                          \
  }
...
#define __inline_functions(float_type, m)                                     \
  __m81_defun (float_type, m (__scalbln), (float_type __x, long int __n), )   \
  {                                                                           \
  ...
  {                                                                           \
    ...
    return __result;                                                          \
			    ...
			    __inline_functions (double, __CONCAT_d) __inline_functions (
				float,
				__CONCAT_f) __inline_functions (long double,
								__CONCAT_l)
#undef __inline_functions

#define __inline_functions(float_type, m)                                     \
  __m81_inline void __m81_nth (__m81_u (m (__sincos)) (                       \
...
#define __inline_mathop1(float_type, func, op, attrs)                         \
  ...
  {                                                                           \
    ...
    return __result;                                                          \
				    ...
				    __inline_mathop (__ieee754_acos, acos, ) __inline_mathop (
					__ieee754_asin,
					asin, ) __inline_mathop (__ieee754_cosh,
								 cosh, )
					__inline_mathop (
					    __ieee754_sinh,
					    sinh, ) __inline_mathop (__ieee754_exp,
								     etox, )
					    __inline_mathop (
						__ieee754_exp2,
						twotox, ) __inline_mathop (__ieee754_exp10,
									   tentox, )
						__inline_mathop (
						    __ieee754_log10, log10, )
						    __inline_mathop (
							__ieee754_log2, log2, )
							__inline_mathop (
							    __ieee754_log,
...
__m81_defun (long double, __ieee754_remainderl,
...
__m81_defun (long double, __ieee754_fmodl,
	     (long double __x, long double __y), )
{
  long double __result;
  __asm ("fmod%.x %1, %0" : "=f"(__result) : "f"(__y), "0"(__x));
