/*
 * GrateOS syscall number definitions
 *
 * This file contains syscall number constants used by GrateOS WASM to map
...
#ifndef _GRATEOS_SYSCALL_NUM_H
#define _GRATEOS_SYSCALL_NUM_H
...
/* GrateOS-specific syscalls (not part of the Linux syscall table) */
