...
signed int __imported_grateos_args_sizes_get(signed int arg0, signed int arg1) __attribute__((
    __import_module__("grateos"),
    __import_name__("args_sizes_get")
));

unsigned short __grateos_args_sizes_get(
    unsigned long *retptr0,
    unsigned long *retptr1
){
    signed int ret = __imported_grateos_args_sizes_get((signed int) retptr0, (signed int) retptr1);
    return (unsigned short) ret;
}

signed int __imported_grateos_args_get(signed int arg0, signed int arg1) __attribute__((
    __import_module__("grateos"),
    __import_name__("args_get")
));

unsigned short __grateos_args_get(
    unsigned char * * argv,
    unsigned char * argv_buf
){
    signed int ret = __imported_grateos_args_get((signed int) argv, (signed int) argv_buf);
    return (unsigned short) ret;
}

signed int __imported_grateos_environ_get(signed int arg0, signed int arg1) __attribute__((
    __import_module__("grateos"),
    __import_name__("environ_get")
));

unsigned short __grateos_environ_get(
    unsigned char * * environ,
    unsigned char * environ_buf
){
    signed int ret = __imported_grateos_environ_get((signed int) environ, (signed int) environ_buf);
    return (unsigned short) ret;
}

signed int __imported_grateos_environ_sizes_get(signed int arg0, signed int arg1) __attribute__((
    __import_module__("grateos"),
    __import_name__("environ_sizes_get")
));

unsigned short __grateos_environ_sizes_get(
    unsigned long *retptr0,
    unsigned long *retptr1
){
    signed int ret = __imported_grateos_environ_sizes_get((signed int) retptr0, (signed int) retptr1);
    return (unsigned short) ret;
}
...
void __grateos_initialize_environ(void) {
    // Get the sizes of the arrays we'll have to create to copy in the environment.
    size_t environ_count;
    size_t environ_buf_size;
    __grateos_environ_sizes_get(&environ_count, &environ_buf_size);
    ...
    __grateos_environ_get((unsigned char **)environ_ptrs, (unsigned char *)environ_buf);
...
int __main_void(void) {
    ...
    size_t argc;
    __grateos_args_sizes_get(&argc, &argv_buf_size);
    ...
    __grateos_args_get((unsigned char **)argv, (unsigned char *)argv_buf);
...
int _start() {
    __grateos_init_addr_translation(); // iniatilize cageids before anything else executes
    __libc_setup_tls();
    __wasi_init_tp();
    __grateos_initialize_environ();
    __ctype_init(); //grateos-wasm: init ctypes for isalpha etc.
    #ifdef GRATEOS_DEBUG
    	__grateos_debug_import();
    #endif
// GrateOS-Wasm: conditional compilation to ensure exit() is called before program termination,
