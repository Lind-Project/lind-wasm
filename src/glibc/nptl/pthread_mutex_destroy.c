...
___pthread_mutex_destroy (pthread_mutex_t *mutex)
{
  ...
  /* Set to an invalid value.  Relaxed MO is enough as it is undefined behavior
     if the mutex is used after it has been destroyed.  But you can
     reinitialize it with pthread_mutex_init.  */
...
libc_hidden_ver (___pthread_mutex_destroy, __pthread_mutex_destroy)
	...
	compat_symbol (libpthread, ___pthread_mutex_destroy,
		       __pthread_mutex_destroy, GLIBC_2_0);
#endif
