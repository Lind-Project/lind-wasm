...
use crate::module::{
    FuncRefIndex, Initializer, MemoryInitialization, MemoryInitializer, Module, TablePlan,
                ...
                for subsection in dylinks {
                    ...
                    match subsection {
                        ...
                        wasmparser::Dylink0Subsection::RuntimePath(_rtp) => {
                            grateos_log!(DYLINK, "Warning: Dylink.0 RuntimePath Section not handled");
                        }
                        wasmparser::Dylink0Subsection::Unknown {
                            ...
                            grateos_log!(DYLINK, "Dylink.0 Unknown Section Encountered!");
                        }
                    }
                }
            }
