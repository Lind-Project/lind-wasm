...
define_tunables! {
    ...
    pub struct Tunables {
        ...
        /// grateos-wasm:
        /// Initial reservation, in bytes, for grateos-wasm internal memories
        ...
        /// Whether we implement a one-entry cache at each call_indirect site.
        pub cache_call_indirects: bool,

        /// The maximum number of call-indirect cache slots to allocate per instance.
...
impl Tunables {
    ...
    pub fn default_miri() -> Tunables {
        Tunables {
            ...
            grateos_internal_memory_reservation: 10 * (1 << 20),
