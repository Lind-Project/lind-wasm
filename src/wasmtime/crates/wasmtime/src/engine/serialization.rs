...
impl Metadata<'_> {
    ...
    fn check_tunables(&mut self, other: &Tunables) -> Result<()> {
        let Tunables {
            ...
            grateos_internal_memory_reservation: _,
            ...
            // Call-indirect caching: runtime optimization, doesn't affect ABI.
            cache_call_indirects: _,
            max_call_indirect_cache_slots: _,
        } = self.tunables;
