...
use crate::trampoline::{create_handle, create_handle_test};
use crate::TableType;
...
pub fn create_table_test(store: &mut StoreOpaque, table: &TableType) {
    let mut module = Module::new();
    ...
    create_handle_test(module, store, Box::new(()), &[], None);
}
